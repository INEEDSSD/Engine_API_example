...
#defineGLSL LitFS
    ...
    void main()
    {
        ...
        o.Normal = normalize(getTBN() * UnpackNormalmapRGorAG2(norm));

        vec4 finalColor = LambertDirectionLighting(o) + LambertPointLighting(o);
        // vec4 finalColor = LambertPointLighting(o);
        #ifdef FOG
...
#defineGLSL depthNormalPS
    ...
    #define SHADER_NAME BumpedDiffuse_DepthNormal
