Shader3D Start
{
    ...
    shaderPass:[
        {
            pipeline:Forward,
            VS:myCustom2DShader2VS,
            FS:myCustom2DShader2PS
        }
    ]
}
Shader3D End
...
GLSL Start
#defineGLSL myCustom2DShader2VS

    #define SHADER_NAME myCustom2DShader2
...
#defineGLSL myCustom2DShader2PS
    #define SHADER_NAME myCustom2DShader2
    ...
    void main()
    {
        ...
        textureColor = textureColor * vec4(0, 0.5, 0, 1);
