Shader3D Start
{
    ...
    shaderPass:[
        {
            pipeline:Forward,
            VS:myCustom2DShader4VS,
            FS:myCustom2DShader4PS
        }
    ]
}
Shader3D End
...
GLSL Start
#defineGLSL myCustom2DShader4VS

    #define SHADER_NAME myCustom2DShader4
...
#defineGLSL myCustom2DShader4PS
    #define SHADER_NAME myCustom2DShader4
    ...
    void main()
    {
        ...
        textureColor = textureColor * vec4(0, 0, 0.5, 1);
