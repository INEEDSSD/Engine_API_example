...
var __bundle__ = (() => {
  ...
  // INDEX:WebGPU.scene.js
  var WebGPU_scene_exports = {};
  __export(WebGPU_scene_exports, {
    BundleCullingRender: () => BundleCullingRender
  });

  // assets/bundleCulling/src/BundleCullingBundleElement.ts
  ...
  // assets/bundleCulling/src/BundleCullingComputeShader.ts
...
`;
  ...
  // assets/bundleCulling/src/BundleCullingRenderElement.ts
  ...
  // assets/bundleCulling/src/BundleCullingRender.ts
  ...
  BundleCullingRender = __decorateClass([
    regClass("4eb6ec29-a744-4d83-a656-ebdfeb97188f", "bundleCulling/src/BundleCullingRender.ts")
  ], BundleCullingRender);
  return __toCommonJS(WebGPU_scene_exports);
})();
window.__setBundle_ && window.__setBundle_("MHrn72u2R-aHUoxvsccg7Q", __bundle__)
//# sourceMappingURL=WebGPU.scene.js.map
