...
(() => {
  ...
  var Render_2DCamera = class extends BaseScript {
    ...
    setCameraLimit(camera2d) {
      camera2d.limit_Top = -1e3;
      camera2d.limit_Bottom = -1e3;
      camera2d.limit_Left = -1e3;
      camera2d.limit_Right = -1e3;
    }
  };
  ...
  var Render_2DLight = class extends BaseScript {
    ...
    onEnable() {
      ...
      Laya.loader.load(["resources/res/light.png", "resources/res/bg2.png", "resources/res/apes/monkey2.png", "resources/res/apes/monkey1.png"]).then(() => {
        let monkey = Laya.loader.getRes("resources/res/apes/monkey2.png");
        let light = Laya.loader.getRes("resources/res/light.png");
    ...
    add2DLightOccluder(res) {
      ...
      mesh2Drender.sharedMesh = this.generateRectVerticesAndUV(1e5, 1e5);
  ...
  __name(_lightRotate, "lightRotate");
  var lightRotate = _lightRotate;
  var _testMove = class _testMove extends Laya.Script {
    /**
     * 键盘按下时执行
     * @param 鼠标事件
     */
  ...
  var Render_CMDRender = class extends BaseScript {
     ...
     */
    createMesh2DCMD(rt, mesh2d, meshTexture) {
      let cmd = Render_CMDRender.cmd = new Laya.CommandBuffer2D("test");
      cmd.setRenderTarget(rt, true, Laya.Color.RED);
     ...
     * @param meshTexture 
     */
    createMesh2DRenderCMD(rt, mesh, meshTexture) {
      ...
      let cmd = Render_CMDRender.cmd = new Laya.CommandBuffer2D("test");
      cmd.setRenderTarget(rt, true, Laya.Color.GREEN);
     ...
     * @param meshTexture 
     */
    create2DBlitCMD(rt, meshTexture) {
      let cmd = Render_CMDRender.cmd = new Laya.CommandBuffer2D("test");
      cmd.setRenderTarget(rt, true, Laya.Color.BLUE);
      cmd.blitTextureQuad(meshTexture, rt, new Laya.Vector4(0, 0, 0.3, 0.3));
      cmd.blitTextureQuad(meshTexture, rt, new Laya.Vector4(0.3, 0.3, 0.5, 0.5));
      cmd.blitTextureQuad(meshTexture, rt, new Laya.Vector4(0.8, 0.8, 0.2, 0.2));
      cmd.apply(true);
      Laya.Utils3D.uint8ArrayToArrayBufferAsync(rt).then((res) => {
        console.log(res);
      });
  ...
  var Render_Material = class extends BaseScript {
    ...
    onAwake() {
      super.base();
      let res = "resources/res/apes/monkey3.png";
      Laya.loader.load(res).then(() => {
    ...
    set2DCustomMaterial() {
      ...
      Laya.loader.load("resources/res/2DRender/customMaterial_1.lmat").then((mat) => {
    ...
    loadCustom2DShader(sp) {
      Laya.loader.load("resources/res/2DRender/custom2DShader_0.shader").then(() => {
        ...
        this.owner.scene.sceneShaderData.setColor(Laya.Shader3D.propertyNameToID("u_GlobalColor"), new Laya.Color(0, 1, 0, 1));
  ...
  var Render_MeshRender = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load(this.res, Laya.Loader.TEXTURE2D).then((res) => {
        let tex2d = res;
  ...
  var Spine_instance = class extends BaseScript {
    ...
    onAwake() {
      ...
      for (let i = 0; i < 3e3; i++) {
        let item = this.owner.addChild(this.spinePrefab.create());
        item.x = 100 + i * 3;
        item.y = 700;
        let x = i % stageWidth;
  ...
  var _RandomWalk = class _RandomWalk extends Laya.Script {
    constructor() {
      ...
      this.curStepX = 0;
      this.curStepY = 0;
      this.loopID = _RandomWalk.ID++ % 120;
    }
    onUpdate() {
  ...
  var Render_TrailRender = class extends BaseScript {
    ...
    //组件被启用后执行，例如节点被添加到舞台后
    onEnable() {
      Laya.loader.load("resources/res/apes/monkey2.png").then((res) => {
        this.showApe(res);
      });
    }
    showApe(img) {
      ...
      ape.pos(300, 300);
      ape2.pos(100, 100);
      this.trail2Drender = ape2.addComponent(Laya.Trail2DRender);
  ...
  var InputDevice_Compasss = class extends BaseScript {
    ...
    onOrientationChange(absolute, info) {
      if (info.alpha === null) {
        alert("当前设备不支持陀螺仪。");
      } else if (this.firstTime && !absolute && !Browser3.onIOS) {
  ...
  var InputDevice_Map = class extends BaseScript {
    constructor() {
      super();
      this.BMap = Browser4.window.BMap;
    }
    onAwake() {
      ...
      this.initMap();
      this.createInfoText();
      var successHandler = new Handler2(this, this.updatePosition);
      var errorHandler = new Handler2(this, this.onError);
      Geolocation.enableHighAccuracy = true;
      Geolocation.watchPosition(successHandler, errorHandler);
      this.convertToBaiduCoord = this.convertToBaiduCoord.bind(this);
    }
    onDestroy() {
      Browser4.removeElement(this.mapDiv);
    }
    createDom() {
      this.mapDiv = Browser4.createElement("div");
      var style = this.mapDiv.style;
      style.position = "absolute";
      style.top = "50px";
      style.left = "0px";
      style.width = Browser4.width / Browser4.pixelRatio + "px";
      style.height = Browser4.height / Browser4.pixelRatio + "px";
      Browser4.document.body.appendChild(this.mapDiv);
      if (Index.curPage)
        SpriteUtils3.fitDOMElementInArea(this.mapDiv, this.box2D, Index.pagePos.x, Index.pagePos.y + 50, this.pageWidth, this.pageHeight - 50);
    }
    initMap() {
  ...
  var Interaction_FixInteractiveRegion = class extends BaseScript {
    ...
    createDeepSkyblueRect() {
      var deepSkyblueRect = new Sprite11();
    ...
    createDarkOrchidRect() {
      var darkOrchidRect = new Sprite11();
  ...
  var Loader_SingleType = class extends BaseScript {
    ...
    onAssetLoaded2() {
      let textures = [
        Loader4.getRes("resources/res/apes/monkey0.png"),
        Loader4.getRes("resources/res/apes/monkey1.png"),
        Loader4.getRes("resources/res/apes/monkey2.png")
      ];
      for (let i = 0; i < 3; i++) {
        let sp = new Laya.Sprite();
  ...
  var NetWork_Socket = class extends BaseScript {
    ...
    connect() {
      ...
      this.socket.on(Event16.OPEN, this, this.onSocketOpen);
      this.socket.on(Event16.CLOSE, this, this.onSocketClose);
      this.socket.on(Event16.MESSAGE, this, this.onMessageReveived);
      this.socket.on(Event16.ERROR, this, this.onConnectError);
    }
    onSocketOpen(e = null) {
  ...
  var Network_GET = class extends BaseScript {
    ...
    connect() {
      ...
      this.hr.once(Event17.PROGRESS, this, this.onHttpRequestProgress);
      this.hr.once(Event17.COMPLETE, this, this.onHttpRequestComplete);
      this.hr.once(Event17.ERROR, this, this.onHttpRequestError);
      this.hr.send("https://httpbin.org/get", null, "get", "text");
    }
    showLogger() {
      this.logger = new Text9();
      this.logger.fontSize = 30;
      this.logger.color = "#FFFFFF";
      this.logger.align = "center";
      this.logger.valign = "middle";
  ...
  var PIXI_Example_1 = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.createText();
      this.start();
      this.box2D.on(Event19.RESIZE, this, this.resize);
    }
    start() {
      for (var i = 0; i < this.starCount; i++) {
        var tempBall = new Sprite18();
  ...
  var PIXI_Example_2 = class extends BaseScript {
    ...
    setup() {
      this.box2D.on(Event20.RESIZE, this, this.onResize);
      this.makeObject(0);
  ...
  var PIXI_Example_3 = class extends BaseScript {
    ...
    createCanvases() {
      var graphicsCanvas = new Sprite20();
      this.box2D.addChild(graphicsCanvas);
      var liveGraphicsCanvas = new Sprite20();
  ...
  var PerformanceTest_Skeleton = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/skeleton/" + this.fileName + "/" + this.fileName + ".sk").then((templet) => {
        ...
        this.box2D.on(Event21.CLICK, this, this.toggleAction);
      });
    }
    onDestroy() {
      this.box2D.off(Event21.CLICK, this, this.toggleAction);
    }
    toggleAction(e = null) {
      this.mActionIndex++;
  ...
  var Physics_Bridge = class extends BaseScript {
    ...
    onStart() {
      ...
      this.physicsManager = this.owner.getComponentElementManager(Laya.Physics2DWorldManager.__managerName);
      this.createBridge();
      this.eventListener();
    }
    createBridge() {
      const startPosX = 250, startPosY = 450;
      let ground = new Sprite25();
      ...
      for (let i = 0; i < this.ecount; i++) {
        ...
        let boxShape2 = new Laya.BoxShape2D();
        let shapes = [];
        shapes.push(boxShape2);
        boxShape2.width = width;
        boxShape2.height = height;
        boxShape2.density = 20;
        boxShape2.friction = 0.2;
        boxShape2.y = -height / 2;
        rb.shapes = shapes;
    ...
    eventListener() {
      ...
      let label = this.label = this.owner.addChild(new Label("单击屏幕产生新的小球刚体，击向bridge的随机位置"));
      label.top = 20;
      label.right = 20;
      label.fontSize = 16;
      label.color = "#e69999";
    ...
    onDisable() {
      if (this.box2D) {
        this.box2D.offAll(Event22.CLICK);
        this.box2D = null;
      }
    }
  };
  ...
  var Physics_CollisionEvent = class extends BaseScript {
    ...
    createSensor() {
      ...
      for (let i = 0, len = this.count; i < len; i++) {
        ...
        let circleShape2 = new Laya.CircleShape2D();
        circleShape2.radius = 20;
        circleShape2.x = circleShape2.y = 20;
        rb.shapes = [circleShape2];
        sp.addComponent(MouseJoint);
        sp.on(Event23.TRIGGER_ENTER, this, this.onTriggerEnter);
        sp.on(Event23.TRIGGER_EXIT, this, this.onTriggerExit);
      }
    ...
    onTriggerEnter(colliderB, colliderA, contact) {
      if (colliderB === this.sensorCollider) {
        ...
        let bodyB = colliderA.owner.getComponent(RigidBody2);
    ...
    onDisable() {
      if (this.sensorCollider) {
        ...
        ground.off(Event23.TRIGGER_ENTER, this, this.onTriggerEnter);
        ground.off(Event23.TRIGGER_EXIT, this, this.onTriggerExit);
  ...
  var Physics_CollisionFiltering = class extends BaseScript {
    ...
    createBox(posx, posy, width, height, ratio) {
      let box = new Sprite27();
      box.on(Event24.MOUSE_DOWN, this, this.mouseDown);
    ...
    createTriangle(posx, posy, side, ratio) {
      let triangle = new Sprite27();
      triangle.on(Event24.MOUSE_DOWN, this, this.mouseDown);
    ...
    createCircle(posx, posy, radius, ratio) {
      let circle = new Sprite27();
      circle.on(Event24.MOUSE_DOWN, this, this.mouseDown);
    ...
    mouseDown(e) {
      ...
      Laya.timer.callLater(mouseJoint, mouseJoint._onMouseDown);
      Laya.stage.on(Event24.MOUSE_UP, this, this.destoryJoint);
      Laya.stage.on(Event24.MOUSE_OUT, this, this.destoryJoint);
    }
    mouseMove(e) {
    ...
    mouseUp() {
      Laya.stage.off(Event24.MOUSE_MOVE, this, this.mouseMove);
      Laya.stage.off(Event24.MOUSE_UP, this, this.mouseUp);
      Laya.stage.off(Event24.MOUSE_OUT, this, this.mouseUp);
    ...
    destoryJoint() {
      Laya.stage.off(Event24.MOUSE_UP, this, this.destoryJoint);
      Laya.stage.off(Event24.MOUSE_OUT, this, this.destoryJoint);
    ...
    onDisable() {
      if (this.box2D) {
        this.box2D.off(Event24.MOUSE_MOVE, this, this.mouseMove);
        this.box2D.off(Event24.MOUSE_UP, this, this.mouseUp);
        this.box2D.off(Event24.MOUSE_OUT, this, this.mouseUp);
        this.box2D.off(Event24.MOUSE_UP, this, this.destoryJoint);
        this.box2D.off(Event24.MOUSE_OUT, this, this.destoryJoint);
        this.box2D = null;
      }
    }
  };
  ...
  var Physics_MassAndCenter = class extends Laya.Script {
    ...
    //组件被启用后执行，例如节点被添加到舞台后
    onEnable() {
      let rig = this.bullet.getComponent(Laya.RigidBody);
      rig.applyForce({ x: 0, y: 0 }, { x: 3e3, y: 0 });
      let rig1 = this.bullet1.getComponent(Laya.RigidBody);
      rig1.applyForce({ x: 0, y: 0 }, { x: 3e3, y: 0 });
    }
    //组件被禁用时执行，例如从节点从舞台移除后
    //onDisable(): void {}
    //第一次执行update之前执行，只会执行一次
  ...
  var Physics_Strandbeests = class extends BaseScript {
    ...
    Construct() {
      ...
      rigidbody.shapes = [chainShape];
      for (let i = 1; i <= 32; i++) {
        let small = new Sprite28();
        small.name = "ground" + i;
        small.pos(i * 30 + 50, 570 - 5 * this.scale);
        small.addComponent(RigidBody4);
        let smRd = small.getComponent(RigidBody4);
        smRd.applyOwnerColliderComponent = false;
        this.owner.addChild(small);
        let circleshape2 = new Laya.CircleShape2D();
        circleshape2.radius = 2.5 * this.scale;
        smRd.shapes = [circleshape2];
      }
      let chassis = this.chassis = new Sprite28();
      ...
      let wheel = this.wheel = new Sprite28();
      ...
      this.createLeg(1, wheelAnchor, 0);
      this.createLeg(-1, wheelAnchor, Laya.Utils.toRadian(120));
      this.createLeg(1, wheelAnchor, Laya.Utils.toRadian(120));
      this.createLeg(-1, wheelAnchor, Laya.Utils.toRadian(-120));
      this.createLeg(1, wheelAnchor, Laya.Utils.toRadian(-120));
    }
    ...
    eventListener() {
      Laya.stage.on(Event25.DOUBLE_CLICK, this, () => {
        this.motorJoint.motorSpeed = -this.motorJoint.motorSpeed;
      });
      let index = 0;
      Laya.stage.on(Event25.CLICK, this, () => {
        let tempVec = this.TempVec;
        let newBall = new Sprite28();
    ...
    createCheckBox(lable, isselect, x, y) {
      var cb = new Laya.CheckBox("atlas/comp/checkbox.png");
    ...
    onDisable() {
      if (this.box2D) {
        this.box2D.offAll(Event25.CLICK);
        this.box2D.offAll(Event25.DOUBLE_CLICK);
        this.box2D = null;
      }
    }
  };
  ...
  var Physics_Tumbler = class extends BaseScript {
    ...
    addMiniBox() {
      ...
      let boxBody = sp.addComponent(RigidBody5);
      boxBody.applyOwnerColliderComponent = false;
      let boxshape = new Laya.BoxShape2D();
      boxshape.width = 5;
      boxshape.height = 5;
    ...
    eventListener() {
      ...
      label.fontSize = 16;
      label.color = "#e69999";
      this.box2D.on(Event26.DOUBLE_CLICK, this, () => {
        this.totalBox += 100;
      });
    ...
    onDisable() {
      if (this.box2D) {
        this.box2D.offAll(Event26.DOUBLE_CLICK);
        this.box2D = null;
      }
    }
  };
  ...
  var Skeleton_ChangeSkin = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/spine/spineRes2/goblins.sk").then((templet) => {
        ...
        this.mArmature.on(Event27.STOPPED, this, this.completeHandler);
        this.play();
        this.changeSkin();
    ...
    onDestroy() {
      ...
      this.mArmature.off(Event27.STOPPED, this, this.completeHandler);
    }
  };
  ...
  var Skeleton_SpineAdapted = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/spine/spineboy-pro.skel", Loader6.SPINE).then((templet) => {
        ...
        this.skeleton.on(Event29.STOPPED, this, this.play);
        this.play();
      });
    }
    play() {
  ...
  var Skeleton_SpineEvent = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/spine/spineRes6/alien.sk").then((templet) => {
        ...
        this.mArmature.scale(0.5, 0.5);
        this.owner.addChild(this.mArmature);
        this.mArmature.on(Event30.LABEL, this, this.onEvent);
  ...
  Skeleton_SpineStretchyman = __decorateClass([
    regClass69("9428bf05-d5f5-4e58-a562-90e01db5af80", "../src/2D/Skeleton/Skeleton_SpineStretchyman.ts")
  ...
  Skeleton_SpineVine = __decorateClass([
    regClass70("58d15757-1949-49e4-8863-0e26e5244c44", "../src/2D/Skeleton/Skeleton_SpineVine.ts")
  ], Skeleton_SpineVine);
  ...
  var Sound_SimpleDemo = class extends BaseScript {
    ...
    setup() {
      ...
      soundButton.on(Event33.CLICK, this, this.onPlaySound);
      musicButton.on(Event33.CLICK, this, this.onPlayMusic);
    }
    createButton(label) {
      var w = 110;
      var h = 40;
    ...
    onPlayMusic(e = null) {
      if (this._musicIndex % 2 == 0) {
        console.log("播放音乐 bgm.mp3");
        SoundManager.playMusic("resources/res/sounds/bgm.mp3", 1, new Handler5(this, this.onComplete));
      } else {
        console.log("播放音乐 bgm1.mp3");
        SoundManager.playMusic("resources/res/sounds/bgm1.mp3", 1, new Handler5(this, this.onComplete));
      }
      this._musicIndex++;
    }
    onPlaySound(e = null) {
      if (this._soundIndex % 2 == 0) {
        console.log("播放音效 btn.mp3");
        SoundManager.playSound("resources/res/sounds/btn.mp3", 1, new Handler5(this, this.onComplete));
      } else {
        console.log("播放音效 destroy.wav");
        SoundManager.playSound("resources/res/sounds/destroy.wav", 1, new Handler5(this, this.onComplete));
      }
      this._soundIndex++;
    }
    onComplete() {
  ...
  Sound_SimpleDemo = __decorateClass([
    regClass71("4284d2ac-4597-45fa-9ede-342369ccae35", "../src/2D/Sound/Sound_SimpleDemo.ts")
  ], Sound_SimpleDemo);
  ...
  var Sprite_BinaryImage = class extends BaseScript {
    ...
    onAwake() {
      Laya.loader.fetch("resources/res/test.bin", "arraybuffer").then((arrayBuffer) => {
    ...
    showApe1() {
      ...
      this.fileReader.onload = (e) => {
        ...
        this.sp.loadImage(e.target.result);
        this.sp.x = 10;
  ...
  Sprite_BinaryImage = __decorateClass([
    regClass72("6830521c-bf37-473b-bb75-9e8399bbcaab", "../src/2D/Sprite/Sprite_BinaryImage.ts")
  ], Sprite_BinaryImage);
  ...
  Sprite_Cache = __decorateClass([
    regClass73("b1c27db6-bef3-4e4b-9222-4283acd98d50", "../src/2D/Sprite/Sprite_Cache.ts")
  ], Sprite_Cache);
  ...
  Sprite_Container = __decorateClass([
    regClass74("2812157c-5a61-4d9e-899c-96c7c41460fb", "../src/2D/Sprite/Sprite_Container.ts")
  ], Sprite_Container);
  ...
  Sprite_DisplayImage = __decorateClass([
    regClass75("622a88a7-667e-46e7-843d-166c7d06018b", "../src/2D/Sprite/Sprite_DisplayImage.ts")
  ], Sprite_DisplayImage);
  ...
  Sprite_DrawPath = __decorateClass([
    regClass76("91e0f116-48ba-450a-8860-c66bf714221c", "../src/2D/Sprite/Sprite_DrawPath.ts")
  ], Sprite_DrawPath);
  ...
  Sprite_DrawShapes = __decorateClass([
    regClass77("8b346388-272f-454f-bf68-0a1087a7f2cf", "../src/2D/Sprite/Sprite_DrawShapes.ts")
  ], Sprite_DrawShapes);
  ...
  Sprite_Guide = __decorateClass([
    regClass78("4c31a0b2-da12-464c-821b-fa3e2521c9ec", "../src/2D/Sprite/Sprite_Guide.ts")
  ], Sprite_Guide);
  ...
  Sprite_MagnifyingGlass = __decorateClass([
    regClass79("781d3498-3b70-42c0-9931-19cca7dd3c2e", "../src/2D/Sprite/Sprite_MagnifyingGlass.ts")
  ...
  Sprite_NodeControl = __decorateClass([
    regClass80("9b0b2bc8-0e72-4d28-a70e-dea5d386679e", "../src/2D/Sprite/Sprite_NodeControl.ts")
  ], Sprite_NodeControl);
  ...
  Sprite_Pivot = __decorateClass([
    regClass81("43d05e39-950f-4ef6-bc8d-f4b64c3a95c5", "../src/2D/Sprite/Sprite_Pivot.ts")
  ], Sprite_Pivot);
  ...
  Sprite_RoateAndScale = __decorateClass([
    regClass82("c995c03a-29f2-42d9-9147-5b6d3c0f5039", "../src/2D/Sprite/Sprite_RoateAndScale.ts")
  ], Sprite_RoateAndScale);

  // src/2D/Sprite/Sprite_ScreenShot.ts
  Laya.addBeforeInitCallback(function() {
  });
  ...
  var Sprite_ScreenShot = class extends BaseScript {
    constructor() {
      super();
      this.resArr = ["resources/res/apes/monkey3.png", "resources/image/img_btn_bg.png"];
      this.nameArr = ["画布截屏显示", "舞台截屏绘制", "单图转base64显示", "清空所有新图"];
    }
    onAwake() {
      super.base();
    ...
    _onclick(e) {
      switch (e.target.name) {
        case this.nameArr[0]:
          ...
          break;
        case this.nameArr[1]:
          let rt2d = Laya.stage.drawToRenderTexture2D(Browser5.clientWidth * Laya.stage.clientScaleX, Browser5.clientHeight * Laya.stage.clientScaleY, 0, 0);
          let tex = new Texture2(rt2d, Texture2.INV_UV);
          this.drawSp.graphics.drawTexture(tex, 0, 0, this.drawSp.width, this.drawSp.height);
          break;
        case this.nameArr[2]:
          const monkeImg = new Sprite40();
  ...
  Sprite_ScreenShot = __decorateClass([
    regClass83("7215a525-ba4a-49c5-bb91-410cd7b5a48d", "../src/2D/Sprite/Sprite_ScreenShot.ts")
  ], Sprite_ScreenShot);
  ...
  Sprite_SwitchTexture = __decorateClass([
    regClass84("dac515e7-e7e9-4cd1-9da2-be3ff5edb050", "../src/2D/Sprite/Sprite_SwitchTexture.ts")
  ...
  Text_AutoSize = __decorateClass([
    regClass85("7637aa31-dad9-415a-bd87-059be135c04f", "../src/2D/Text/Text_AutoSize.ts")
  ], Text_AutoSize);
  ...
  Text_BitmapFont = __decorateClass([
    regClass86("f4e2bacf-0e7b-4cac-9278-13ce67fd9752", "../src/2D/Text/Text_BitmapFont.ts")
  ], Text_BitmapFont);
  ...
  Text_ComplexStyle = __decorateClass([
    regClass87("07534d14-3399-4525-9452-5ea65e8ab848", "../src/2D/Text/Text_ComplexStyle.ts")
  ], Text_ComplexStyle);
  ...
  Text_Editable = __decorateClass([
    regClass88("377ed9c2-39f1-4be3-af65-29f085445173", "../src/2D/Text/Text_Editable.ts")
  ], Text_Editable);
  ...
  Text_HTML = __decorateClass([
    regClass89("69205946-36a4-446a-a53a-337a95d28135", "../src/2D/Text/Text_HTML.ts")
  ], Text_HTML);
  ...
  Text_InputMultiline = __decorateClass([
    regClass90("41608eb0-8f61-40e4-bbb9-da03a8b26e24", "../src/2D/Text/Text_InputMultiline.ts")
  ], Text_InputMultiline);
  ...
  Text_InputSingleline = __decorateClass([
    regClass91("180d8844-d5a7-46e6-8d9b-0f882835324a", "../src/2D/Text/Text_InputSingleline.ts")
  ...
  Text_MaxChars = __decorateClass([
    regClass92("5fc3f7f8-2fca-4d92-ad6b-d3721b169668", "../src/2D/Text/Text_MaxChars.ts")
  ], Text_MaxChars);
  ...
  Text_Overflow = __decorateClass([
    regClass93("20ea3e4f-cf7b-49f1-b427-189400071843", "../src/2D/Text/Text_Overflow.ts")
  ], Text_Overflow);
  ...
  Text_Restrict = __decorateClass([
    regClass94("39106029-9ea6-4607-942f-68d6e10e4e5c", "../src/2D/Text/Text_Restrict.ts")
  ], Text_Restrict);
  ...
  var Text_Scroll = class extends BaseScript {
    ...
    createText() {
      ...
      this.txt.color = "#ffffff";
      this.box2D.addChild(this.txt);
      this.txt.on(Event35.MOUSE_DOWN, this, this.startScrollText);
    }
    /* 开始滚动文本 */
    startScrollText(e) {
      this.prevX = this.txt.mouseX;
      this.prevY = this.txt.mouseY;
      this.box2D.on(Event35.MOUSE_MOVE, this, this.scrollText);
      this.box2D.on(Event35.MOUSE_UP, this, this.finishScrollText);
    }
    /* 停止滚动文本 */
    finishScrollText(e) {
      this.box2D.off(Event35.MOUSE_MOVE, this, this.scrollText);
      this.box2D.off(Event35.MOUSE_UP, this, this.finishScrollText);
    }
    /* 鼠标滚动文本 */
    scrollText(e) {
  ...
  Text_Scroll = __decorateClass([
    regClass95("64bf6e22-81b3-42c1-a25c-646966e07a92", "../src/2D/Text/Text_Scroll.ts")
  ], Text_Scroll);
  ...
  Text_UBB = __decorateClass([
    regClass96("cde6d5b6-0518-414c-a63f-93d65985ead2", "../src/2D/Text/Text_UBB.ts")
  ], Text_UBB);
  ...
  Text_Underline = __decorateClass([
    regClass97("63c38139-0fef-4bc6-b483-32a2c735aa0d", "../src/2D/Text/Text_Underline.ts")
  ], Text_Underline);
  ...
  Text_WordWrap = __decorateClass([
    regClass98("eb21fcf9-4f9b-44b9-8693-a1c6d99d55c6", "../src/2D/Text/Text_WordWrap.ts")
  ], Text_WordWrap);
  ...
  TiledMap_AnimationTile = __decorateClass([
    regClass99("64708305-a2d1-438a-afd9-2cfb5f20370c", "../src/2D/TiledMap/TiledMap_AnimationTile.ts")
  ...
  TiledMap_IsometricWorld = __decorateClass([
    regClass100("36da897b-d4b1-430b-9e46-0d4640e6071a", "../src/2D/TiledMap/TiledMap_IsometricWorld.ts")
  ...
  var TiledMap_LayerDemo = class extends BaseScript {
    constructor() {
      super(...arguments);
      this.collectCellData = /* @__PURE__ */ new Map();
    }
    //组件被激活后执行，此时所有节点和组件均已创建完毕，此方法只执行一次
    onAwake() {
      super.base();
    ...
    createTileSet() {
      ...
      {
        let cellData2 = this.collectCellDataToMap(group0, new Laya.Vector2(6, 2), new Laya.Vector2(1, 1), 1, "Ani_chengbao");
        let alternative = cellData2.cellowner;
      ...
      {
        let cellData2 = this.collectCellDataToMap(group0, new Laya.Vector2(9, 2), new Laya.Vector2(1, 1), 1, "Ani_shuijin");
        let alternative = cellData2.cellowner;
        alternative.animationMode = Laya.TileAnimationMode.DEFAULT;
        alternative.animation_columns = 0;
        alternative.animation_separation = new Laya.Vector2(0, 0);
      ...
      {
        let cellData2 = this.collectCellDataToMap(group1, new Laya.Vector2(0, 0), new Laya.Vector2(4, 3), 0, "pofangzi");
        cellData2 = this.collectCellDataToMap(group1, new Laya.Vector2(0, 0), new Laya.Vector2(4, 3), 1, "pofangzi2");
        cellData2.colorModulate = new Laya.Color(1, 0, 0, 1);
      }
      {
        let cellData2 = this.collectCellDataToMap(group1, new Laya.Vector2(0, 6), new Laya.Vector2(4, 3), 0, "shu1");
        cellData2.cellowner.animation_columns = 1;
        cellData2.cellowner.animationFrams = [1, 1];
      }
      {
        let cellData2 = this.collectCellDataToMap(group1, new Laya.Vector2(17, 0), new Laya.Vector2(3, 3), 0, "liangtin");
      }
      return tileSet;
    }
    /**
  ...
  TiledMap_LayerDemo = __decorateClass([
    regClass101("da0da6e1-a272-442d-9a36-60e4ba8a5c7f", "../src/2D/TiledMap/TiledMap_LayerDemo.ts")
  ], TiledMap_LayerDemo);
  ...
  TiledMap_PerspectiveWall = __decorateClass([
    regClass102("a324d7b5-9adb-4b34-9170-139eb6f6f506", "../src/2D/TiledMap/TiledMap_PerspectiveWall.ts")
  ...
  var TiledMap_SimpleDemo = class extends BaseScript {
    ...
    onAwake() {
      super.base();
      this.createMap();
      this.box2D.on(Event36.MOUSE_DOWN, this, this.mouseDown);
      this.box2D.on(Event36.MOUSE_UP, this, this.mouseUp);
    }
    //创建地图
    createMap() {
    ...
    completeHandler(e = null) {
      this.box2D.on(Event36.RESIZE, this, this.resize);
      this.resize();
      this.onLoaded();
    }
    //鼠标按下拖动地图
    mouseDown(e = null) {
      ...
      this.box2D.on(Event36.MOUSE_MOVE, this, this.mouseMove);
    }
    mouseMove(e = null) {
    ...
    mouseUp(e = null) {
      ...
      this.box2D.off(Event36.MOUSE_MOVE, this, this.mouseMove);
    }
    // 窗口大小改变，把地图的视口区域重设下
    resize(e = null) {
    ...
    dispose() {
      this.box2D.off(Event36.MOUSE_DOWN, this, this.mouseDown);
      this.box2D.off(Event36.MOUSE_UP, this, this.mouseUp);
      this.box2D.off(Event36.RESIZE, this, this.resize);
      this.box2D.off(Event36.MOUSE_MOVE, this, this.mouseMove);
      if (this.tiledMap) {
        this.tiledMap.destroy();
      }
  ...
  TiledMap_SimpleDemo = __decorateClass([
    regClass103("05e90bf2-8094-404e-92ef-4f13b11f62b8", "../src/2D/TiledMap/TiledMap_SimpleDemo.ts")
  ], TiledMap_SimpleDemo);
  ...
  Timer_CallLater = __decorateClass([
    regClass104("8015ee44-a6c5-40c2-9aa1-5c1c2ac1bf28", "../src/2D/Timer/Timer_CallLater.ts")
  ], Timer_CallLater);
  ...
  Timer_DelayExcute = __decorateClass([
    regClass105("d938c758-9e83-434b-b44d-d738431ec10e", "../src/2D/Timer/Timer_DelayExcute.ts")
  ], Timer_DelayExcute);
  ...
  Timer_Interval = __decorateClass([
    regClass106("4f4156a7-8544-449e-b9ed-0970bded88d8", "../src/2D/Timer/Timer_Interval.ts")
  ], Timer_Interval);
  ...
  var Tween_EaseFunctionsDemo = class extends BaseScript {
    ...
    createDurationCrontroller() {
      ...
      durationInput.on(Event38.INPUT, this, () => {
  ...
  Tween_EaseFunctionsDemo = __decorateClass([
    regClass107("0ded21b8-caed-459a-852f-6f3777890a79", "../src/2D/Tween/Tween_EaseFunctionsDemo.ts")
  ...
  Tween_Letters = __decorateClass([
    regClass108("a52ef21b-df96-438e-9f53-765de9ce76e6", "../src/2D/Tween/Tween_Letters.ts")
  ], Tween_Letters);
  ...
  Tween_SimpleSample = __decorateClass([
    regClass109("c38a5109-eee8-4781-b452-5c954d25542e", "../src/2D/Tween/Tween_SimpleSample.ts")
  ], Tween_SimpleSample);
  ...
  var Tween_TimeLine = class extends BaseScript {
    ...
    setup() {
      ...
      this.box2D.on(Event39.KEY_DOWN, this, this.keyDown);
    }
    createApe() {
    ...
    createTimerLine() {
      ...
      this.timeLine.on(Event39.COMPLETE, this, this.onComplete);
      this.timeLine.on(Event39.LABEL, this, this.onLabel);
    }
    onComplete() {
    ...
    onDestroy() {
      this.box2D.off(Event39.KEY_DOWN, this, this.keyDown);
      if (this.timeLine) {
        this.timeLine.on(Event39.COMPLETE, this, this.onComplete);
        this.timeLine.on(Event39.LABEL, this, this.onLabel);
  ...
  Tween_TimeLine = __decorateClass([
    regClass110("d1768db0-3ab6-470a-9675-f0f2b83dc6fb", "../src/2D/Tween/Tween_TimeLine.ts")
  ], Tween_TimeLine);
  ...
  UI_Button = __decorateClass([
    regClass111("0b46ea86-786c-4c5a-9fd6-062333649321", "../src/2D/UI/UI_Button.ts")
  ], UI_Button);
  ...
  UI_CheckBox = __decorateClass([
    regClass112("e4f64c8b-f814-4958-a2ff-ba1a0363c2fc", "../src/2D/UI/UI_CheckBox.ts")
  ], UI_CheckBox);
  ...
  UI_Clip = __decorateClass([
    regClass113("5039f284-c862-4adf-bc29-0dabf734cba8", "../src/2D/UI/UI_Clip.ts")
  ], UI_Clip);
  ...
  UI_ColorPicker = __decorateClass([
    regClass114("26af1428-e015-4af4-9277-bb198c86e4d4", "../src/2D/UI/UI_ColorPicker.ts")
  ], UI_ColorPicker);
  ...
  UI_ComboBox = __decorateClass([
    regClass115("6e79e33f-0a03-4cde-9adf-0e06ecb659c9", "../src/2D/UI/UI_ComboBox.ts")
  ], UI_ComboBox);
  ...
  UI_Dialog = __decorateClass([
    regClass116("6eb2789d-4f8f-449b-a054-057e0ab651ca", "../src/2D/UI/UI_Dialog.ts")
  ], UI_Dialog);
  ...
  UI_FontClip = __decorateClass([
    regClass117("147094c0-1c15-46c1-98a4-b09d1fefac2c", "../src/2D/UI/UI_FontClip.ts")
  ], UI_FontClip);
  ...
  UI_Image = __decorateClass([
    regClass118("fbbe4b6b-30df-4768-8206-a4dfe5b4bac5", "../src/2D/UI/UI_Image.ts")
  ], UI_Image);
  ...
  UI_Input = __decorateClass([
    regClass119("3a772291-31a0-4a47-b2ec-cc5ca8ca1146", "../src/2D/UI/UI_Input.ts")
  ], UI_Input);
  ...
  UI_Label = __decorateClass([
    regClass120("ff6e48bf-3722-4d14-a48b-c2f2295424f6", "../src/2D/UI/UI_Label.ts")
  ], UI_Label);
  ...
  var UI_List = class extends BaseScript {
    ...
    setup() {
      ...
      list.mouseHandler = new Laya.Handler(this, this.onMuseHandler);
  ...
  UI_List = __decorateClass([
    regClass121("6dd768a8-4397-4d82-8148-22d00bf4baec", "../src/2D/UI/UI_List.ts")
  ], UI_List);
  ...
  UI_Panel = __decorateClass([
    regClass122("d2b13fdb-ca9d-4c88-9728-1ca865c9f9b6", "../src/2D/UI/UI_Panel.ts")
  ], UI_Panel);
  ...
  UI_ProgressBar = __decorateClass([
    regClass123("c21a89ee-ebd6-49e1-a11a-6307700020ee", "../src/2D/UI/UI_ProgressBar.ts")
  ], UI_ProgressBar);
  ...
  UI_RadioGroup = __decorateClass([
    regClass124("a662a2ec-427c-49ca-86d1-73be27b23d88", "../src/2D/UI/UI_RadioGroup.ts")
  ], UI_RadioGroup);
  ...
  UI_ScrollBar = __decorateClass([
    regClass125("1d1ff0e3-a8b2-4595-b8fc-d4fa6b2d3b4a", "../src/2D/UI/UI_ScrollBar.ts")
  ], UI_ScrollBar);
  ...
  UI_Slider = __decorateClass([
    regClass126("65a9e444-8f55-40b8-a41f-0ad4418eab7d", "../src/2D/UI/UI_Slider.ts")
  ], UI_Slider);
  ...
  UI_Tab = __decorateClass([
    regClass127("d0973bda-cd73-46f1-9970-92451a8979a6", "../src/2D/UI/UI_Tab.ts")
  ], UI_Tab);
  ...
  UI_TextArea = __decorateClass([
    regClass128("072844be-64d9-497c-913e-dd853e6d633a", "../src/2D/UI/UI_TextArea.ts")
  ], UI_TextArea);
  ...
  UI_Tree = __decorateClass([
    regClass129("d3bf77a4-0a1e-46cc-9048-1f898ae0c747", "../src/2D/UI/UI_Tree.ts")
  ], UI_Tree);
  ...
  var _GlassWithoutGrabMaterial = class _GlassWithoutGrabMaterial extends Laya.Material {
    ...
    constructor(texture) {
      ...
      this.renderModeSet();
      this.shaderData.setVector(_GlassWithoutGrabMaterial.TILINGOFFSET, new Laya.Vector4(1, 1, 0, 0));
      this.shaderData.setTexture(_GlassWithoutGrabMaterial.TINTTEXTURE, texture);
    }
    /**
     * RenderMode
     */
  ...
  var _BlurMaterial = class _BlurMaterial extends Laya.Material {
    ...
    constructor(texelSize, offset) {
      ...
      this.setFloatByIndex(_BlurMaterial.SHADERVALUE_DOWNSAMPLEVALUE, offset);
  ...
  BlurGlass = __decorateClass([
    regClass130("6a7bc5b7-ac78-40d1-975a-19b7d20e0e7b", "../src/3D/Advance/BlurryGlass.ts")
  ], BlurGlass);
  ...
  CameraDepthModeTextureDemo = __decorateClass([
    regClass131("d6fc9519-a7a7-48d7-8431-50af8012c384", "../src/3D/Advance/CameraDepthModeTextureDemo.ts")
  ...
  __decorateClass([
    property131(Laya.Sprite3D)
  ], CameraInteraction.prototype, "directionLight", 2);
  CameraInteraction = __decorateClass([
    regClass132("7a2191ac-590d-4a34-aa9f-7714eead7c62", "../src/3D/Advance/CameraInteraction.ts")
  ], CameraInteraction);
  var _KeyBoard = class _KeyBoard extends Laya.Script {
    ...
    onEnable() {
      ...
      Laya.stage.on(Event40.KEY_DOWN, this, this.onKeyDown);
      Laya.stage.on(Event40.KEY_UP, this, this.onKeyUp);
    }
    onKeyDown(e) {
      switch (e.keyCode) {
        case 87:
  ...
  CommandBuffer_DrawCustomInstance = __decorateClass([
    regClass133("309fd40c-2253-4850-b066-7c34fad9be09", "../src/3D/Advance/CommandBuffer_DrawCustomInstance.ts")
  ...
  __decorateClass([
    property133(Laya.Button)
  ], CommandBuffer_Outline.prototype, "effectBtn", 2);
  CommandBuffer_Outline = __decorateClass([
    regClass134("c7b9e97b-dab7-4d49-9974-6722b5ba39ee", "../src/3D/Advance/CommandBuffer_Outline.ts")
...
\r
  ...
  var GrassShaderFS_default = '#if defined(GL_FRAGMENT_PRECISION_HIGH)// 原来的写法会被我们自己的解析流程处理，而我们的解析是不认内置宏的，导致被删掉，所以改成 if defined 了\r\n	precision highp float;\r\n#else\r\n	precision mediump float;\r\n#endif\r\n#include "Color.glsl";\r\n#include "Scene.glsl"\r\n#include "SceneFog.glsl"\r\n\r\nvarying vec4 v_Color;\r\n\r\nvoid main() {\r\n\r\n    vec4 color = v_Color;\r\n	#ifdef FOG\r\n		// float lerpFact=clamp((1.0/gl_FragCoord.w-u_FogStart)/u_FogRange,0.0,1.0);\r\n		// gl_FragColor.rgb=mix(gl_FragColor.rgb,u_FogColor.rgb,lerpFact);\r\n		color.rgb = scenUnlitFog(color.rgb);\r\n	#endif\r\n	gl_FragColor = color;\r\n	gl_FragColor = outputTransform(gl_FragColor);\r\n}';
  ...
  var _GrassMaterial = class _GrassMaterial extends Laya.Material {
    ...
    setWindA(windIntensity, windFrequency, windTiling, windWrap) {
      this.shaderData.setNumber(_GrassMaterial.WINDAINTENSITY, windIntensity);
      this.shaderData.setNumber(_GrassMaterial.WINDAFREQUECY, windFrequency);
      this.shaderData.setVector2(_GrassMaterial.WINDATILING, windTiling);
      this.shaderData.setVector2(_GrassMaterial.WINDAWRAP, windWrap);
    }
    setWindB(windIntensity, windFrequency, windTiling, windWrap) {
      this.shaderData.setNumber(_GrassMaterial.WINDBINTENSITY, windIntensity);
      this.shaderData.setNumber(_GrassMaterial.WINDBFREQUECY, windFrequency);
      this.shaderData.setVector2(_GrassMaterial.WINDBTILING, windTiling);
      this.shaderData.setVector2(_GrassMaterial.WINDBWRAP, windWrap);
    }
    setWindC(windIntensity, windFrequency, windTiling, windWrap) {
      this.shaderData.setNumber(_GrassMaterial.WINDCINTENSITY, windIntensity);
      this.shaderData.setNumber(_GrassMaterial.WINDCFREQUECY, windFrequency);
      this.shaderData.setVector2(_GrassMaterial.WINDCTILING, windTiling);
      this.shaderData.setVector2(_GrassMaterial.WINDCWRAP, windWrap);
    }
    set grassHight(value) {
      this.shaderData.setNumber(_GrassMaterial.GRASSHEIGHT, value);
    }
    set grassWidth(value) {
      this.shaderData.setNumber(_GrassMaterial.GRASSWIDTH, value);
    }
    set grassGroundColor(value) {
      this.shaderData.setVector3(_GrassMaterial.GROUNDCOLOR, value);
    }
    set grassBoundSize(value) {
      this.shaderData.setVector(_GrassMaterial.GRASSBOUND, value);
    }
    set albedoTexture(value) {
      this.shaderData.setTexture(_GrassMaterial.ALBEDOTEXTURE, value);
    }
  };
  ...
  __decorateClass([
    property134(Laya.Sprite3D)
  ], GrassDemo.prototype, "directionLight", 2);
  GrassDemo = __decorateClass([
    regClass135("d5231def-e006-48c3-9255-c53a9d98e2db", "../src/3D/Advance/GrassDemo.ts")
  ], GrassDemo);
  ...
  __decorateClass([
    property135(Laya.DirectionLightCom)
  ], Laya3DCombineHtml.prototype, "directionLight", 2);
  Laya3DCombineHtml = __decorateClass([
    regClass136("f0a5c24b-f6a4-4272-a7a2-ad8ea4dd8cdf", "../src/3D/Advance/Laya3DCombineHtml.ts")
  ], Laya3DCombineHtml);
  ...
  ReflectionProbe = __decorateClass([
    regClass137("9e38f354-1eda-4e06-8ff9-e6cc6f2e7b02", "../src/3D/Advance/ReflectionProbe.ts")
  ], ReflectionProbe);
  ...
  var Scene2DPlayer3D = class extends BaseScript {
    ...
    */
    sp3ToTexture(lh, sp, layer, isRole = false) {
      Sprite3D.load(lh, Handler17.create(this, (sp3) => {
  ...
  Scene2DPlayer3D = __decorateClass([
    regClass138("b1a8ad5f-4f94-4a9e-a459-06d520ac09f3", "../src/3D/Advance/Scene2DPlayer3D.ts")
  ], Scene2DPlayer3D);
  ...
  Secne3DPlayer2D = __decorateClass([
    regClass139("4980a528-7cac-4b04-8b52-e276f98d4dc2", "../src/3D/Advance/Secne3DPlayer2D.ts")
  ], Secne3DPlayer2D);
...
uniform vec4 u_kernel[17]; //兼容WGSL\r
#include "Color.glsl";\r
\r
vec4 sampleMainTex(sampler2D tex, vec2 uv)\r
{\r
...
`;
  ...
  SeparableSSS_RenderDemo = __decorateClass([
    regClass140("3c9bc866-29a5-4bec-a511-58ef2b18c156", "../src/3D/Advance/SeparableSSS_RenderDemo.ts")
  ...
  var UBO_instance_matBatchDemo = class extends BaseScript {
    ...
    _getRandomPosition(positionRanvge) {
      let getRangeRandom = /* @__PURE__ */ __name(() => {
  ...
  __decorateClass([
    property140(Laya.Material)
  ], UBO_instance_matBatchDemo.prototype, "batchMat", 2);
  __decorateClass([
    property140(Laya.Sprite3D)
  ], UBO_instance_matBatchDemo.prototype, "ownerSp3", 2);
  UBO_instance_matBatchDemo = __decorateClass([
    regClass141("cabcf20f-9f5a-47a0-988b-edc6a0d1e45c", "../src/3D/Advance/UBO_instance_matBatchDemo.ts")
  ...
  var UI3D = class extends BaseScript {
    ...
    onAwake() {
      ...
      var Resource2 = [
        //可以直接加载已经在IDE里制作好的lh
        { url: "resources/res/threeDimen/fbx/Danding.lh", type: Loader7.HIERARCHY },
        { url: "resources/res/ui/prefab/ui3d.lh", type: Loader7.HIERARCHY },
        { url: "resources/res/ui/prefab/ui3dpage.lh", type: Loader7.HIERARCHY }
      ];
  ...
  UI3D = __decorateClass([
    regClass142("cb83f637-7a02-4212-b171-61f071ef5675", "../src/3D/Advance/UI3D.ts")
  ], UI3D);
  ...
  VideoPlayIn3DWorld = __decorateClass([
    regClass143("6af74c14-698e-40a9-906d-f667109ae8f0", "../src/3D/Advance/VideoPlayIn3DWorld.ts")
  ], VideoPlayIn3DWorld);
  var _ChinarMirrorPlane = class _ChinarMirrorPlane extends Script {
    constructor() {
      ...
      this.vn = new Vector39();
      //镜像摄像机的远剪切面的距离
      this.pa = new Vector39();
      //世界坐标系的左下角
      this.pb = new Vector39();
      //世界坐标系的右下角
      this.pc = new Vector39();
      //世界坐标系的左上角
      this.pe = new Vector39();
      //镜像观察角度的世界坐标位置
      this.va = new Vector39();
      //从镜像摄像机到左下角
      this.vb = new Vector39();
      //从镜像摄像机到右下角
      this.vc = new Vector39();
      //从镜像摄像机到左上角
      this.vr = new Vector39();
      //屏幕的右侧旋转轴
      this.vu = new Vector39();
      //屏幕的上侧旋转轴
    ...
    onUpdate() {
      ...
      Vector39.transformV3ToV3(this.mainCamera.transform.position, _ChinarMirrorPlane.tempMat, _ChinarMirrorPlane.tempV3);
      _ChinarMirrorPlane.tempV3.y = -_ChinarMirrorPlane.tempV3.y;
      Vector39.transformV3ToV3(_ChinarMirrorPlane.tempV3, this._mirrorPlane.transform.worldMatrix, _ChinarMirrorPlane.tempV3);
      this.mirrorCamera.transform.position = _ChinarMirrorPlane.tempV3;
      Vector39.transformV3ToV3(_ChinarMirrorPlane.oriPa, this._mirrorPlane.transform.worldMatrix, this.pa);
      Vector39.transformV3ToV3(_ChinarMirrorPlane.oriPb, this._mirrorPlane.transform.worldMatrix, this.pb);
      Vector39.transformV3ToV3(_ChinarMirrorPlane.oriPc, this._mirrorPlane.transform.worldMatrix, this.pc);
      this.pe = this.mirrorCamera.transform.position;
      this.n = this.mirrorCamera.nearPlane;
      this.f = this.mirrorCamera.farPlane;
      Vector39.subtract(this.pa, this.pe, this.va);
      Vector39.subtract(this.pb, this.pe, this.vb);
      Vector39.subtract(this.pc, this.pe, this.vc);
      Vector39.subtract(this.pb, this.pa, this.vr);
      Vector39.subtract(this.pc, this.pa, this.vu);
      Vector39.cross(this.va, this.vc, _ChinarMirrorPlane.tempV3);
      if (Vector39.dot(_ChinarMirrorPlane.tempV3, this.vb) < 0) {
        Vector39.scale(this.vu, -1, this.vu);
        this.pc.cloneTo(this.pa);
        Vector39.add(this.pa, this.vr, this.pb);
        Vector39.add(this.pa, this.vu, this.pc);
        Vector39.subtract(this.pa, this.pe, this.va);
        Vector39.subtract(this.pb, this.pe, this.vb);
        Vector39.subtract(this.pc, this.pe, this.vc);
      }
      Vector39.normalize(this.vr, this.vr);
      Vector39.normalize(this.vu, this.vu);
      Vector39.cross(this.vr, this.vu, _ChinarMirrorPlane.tempV3);
      Vector39.normalize(_ChinarMirrorPlane.tempV3, this.vn);
      this.d = Vector39.dot(this.va, this.vn);
      if (this.setNearClipPlane) {
        this.n = this.d + this.nearClipDistanceOffset;
        this.mirrorCamera.nearPlane = this.n;
      }
      this.l = Vector39.dot(this.vr, this.va) * this.n / this.d;
      this.r = Vector39.dot(this.vr, this.vb) * this.n / this.d;
      this.b = Vector39.dot(this.vu, this.va) * this.n / this.d;
      this.t = Vector39.dot(this.vu, this.vc) * this.n / this.d;
  ...
  _ChinarMirrorPlane.oriPa = new Vector39(5, 0, -5);
  _ChinarMirrorPlane.oriPb = new Vector39(-5, 0, -5);
  _ChinarMirrorPlane.oriPc = new Vector39(5, 0, 5);
  _ChinarMirrorPlane.tempMat = new Matrix4x4();
  _ChinarMirrorPlane.tempV3 = new Vector39();
  ...
  __decorateClass([
    property143({ type: Laya.Camera })
  ], VolumeGIDemo.prototype, "camera", 2);
  __decorateClass([
    property143({ type: Laya.Scene3D })
  ], VolumeGIDemo.prototype, "scene", 2);
  __decorateClass([
    property143({ type: Laya.Sprite3D })
  ], VolumeGIDemo.prototype, "volumeGISp", 2);
  __decorateClass([
    property143({ type: Laya.Sprite3D })
  ], VolumeGIDemo.prototype, "normalSp", 2);
  VolumeGIDemo = __decorateClass([
    regClass144("4327dc36-dd7b-424d-873c-cd95baa284cf", "../src/3D/Advance/VolumeGIDemo.ts")
  ], VolumeGIDemo);
  ...
  var CameraClick = class extends Laya.Script {
    constructor() {
      super();
      this.point = new Vector22();
      this._ray = new Ray(new Vector310(), new Vector310());
      this._outHitResult = new HitResult();
    }
    onAwake() {
      this._camera = this.owner;
      this._scene = this._camera.scene;
      Laya.stage.on(Event41.MOUSE_DOWN, this, this.onMouseDown);
    }
    onMouseDown(event) {
      if (Index.curPage) {
  ...
  CameraClick = __decorateClass([
    regClass145("d0c0cd9c-f7be-4351-a532-e729cfec3a25", "../src/3D/Advance/navMesh/CameraClick.ts")
  ], CameraClick);
  ...
  CameraMove = __decorateClass([
    regClass146("fdb27778-5176-441c-937f-c1f599ae0de9", "../src/3D/Advance/navMesh/CameraMove.ts")
  ], CameraMove);
  ...
  var NavAgent = Laya.NavAgent;
  var NavMesh = class extends BaseScript {
    ...
    onStart() {
      this._angents = [];
      this.getAllComplete(this.owner.scene, this._angents, NavAgent);
      this._scene = this.owner.scene;
      this._lineSprite = new PixelLineSprite3D(1e5);
    ...
    showDebugMesh(suface) {
      ...
      mat.albedoColor = new Color4(0, 0.75, 1, 0.3);
      ...
      for (var j = 0, n1 = tiles.length; j < n1; j++) {
        this.drawBoundingBox(this._lineSprite, tiles.getNavData(j).boundMin, tiles.getNavData(j).boundMax, Color4.RED);
      }
      this.drawBoundingBox(this._lineSprite, suface.min, suface.max, Color4.GREEN);
    }
  ...
  NavMesh = __decorateClass([
    regClass147("c1db5e11-fac1-4274-a649-aa103cefebd2", "../src/3D/Advance/navMesh/NavMesh.ts")
  ], NavMesh);
  ...
  var showFont = class extends BaseScript {
    ...
    onAwake() {
      ...
      var scene = this.scene;
      var camera = this.camera;
      camera.transform.position = new Vector311(0, 0, 15);
      camera.transform.rotate(new Vector311(0, 0, 0), true, false);
      camera.clearColor = new Laya.Color(0.2, 0.2, 0.2, 1);
      let mesh = Laya.PrimitiveMesh.createPlane(10, 10);
      this.plane = new Laya.Sprite3D();
      let meshrender = this.plane.addComponent(Laya.MeshRenderer);
      let meshfilter = this.plane.addComponent(Laya.MeshFilter);
      meshfilter.sharedMesh = mesh;
      this.plane.transform.rotate(new Vector311(-90, 0, 0), true, false);
      scene.addChild(this.plane);
      this.mat = new Laya.UnlitMaterial();
      this.plane.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat;
      ...
      this.plane.getComponent(Laya.MeshRenderer).sharedMaterial.cull = Laya.RenderState.CULL_NONE;
      var rotate = new Vector311(0, 0, 1);
      Laya.timer.frameLoop(1, this, () => {
  ...
  showFont = __decorateClass([
    regClass148("44e834ee-b3dc-4126-82dd-23c7705c857f", "../src/3D/Advance/showFont.ts")
  ], showFont);
  ...
  AnimatorDemo = __decorateClass([
    regClass149("9ee20e05-3a9e-495b-871d-8a273d7eb552", "../src/3D/Animation/AnimatorDemo.ts")
  ], AnimatorDemo);
  ...
  AnimatorStateScriptDemo = __decorateClass([
    regClass150("0f5c142a-89d9-42b4-802b-9e4b33f5a077", "../src/3D/Animation/AnimatorStateScriptDemo.ts")
  ...
  AnimatorTransitionDemo = __decorateClass([
    regClass151("45337063-16d3-4ad6-9d52-93e779278f45", "../src/3D/Animation/AnimatorTransitionDemo.ts")
  ...
  var AvatarMask = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.loadFont();
      Scene3D.load("resources/res/threeDimen/LayaScene_MaskModelTest/maskScene.ls", Handler18.create(this, (scene) => {
  ...
  AvatarMask = __decorateClass([
    regClass152("4c6000fc-52ee-4720-ace5-883640adc226", "../src/3D/Animation/AvatarMask.ts")
  ], AvatarMask);
  ...
  var BoneLinkSprite3D = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector314(-0.01, 2, 4.5);
      this.camera.transform.rotationEuler = new Vector314(-17.3, 0.07, -0.1);
      this.directionLight.getComponent(Laya.DirectionLightCom).color.setValue(1, 1, 1, 1);
      var mat = this.directionLight.transform.worldMatrix;
      mat.setForward(new Vector314(-1, -1, -1));
      this.directionLight.transform.worldMatrix = mat;
      var resource = [
        "resources/res/threeDimen/skinModel/BoneLinkScene/Assets/XunLongShi/Bary/Bary.lh",
      ...
      Laya.loader.load(resource, Handler19.create(this, this.onLoadFinish));
    }
    onLoadFinish() {
      ...
      state2.clip.islooping = true;
      this.animator.getControllerLayer(0).addState(state2);
      this.dragon1 = Loader8.createNodes("resources/res/threeDimen/skinModel/BoneLinkScene/Assets/XunLongShi/Bary/Bary.lh");
      ...
      this.dragon2 = Loader8.createNodes("resources/res/threeDimen/skinModel/BoneLinkScene/Assets/XunLongShi/Carn/Carn.lh");
    ...
    loadUI() {
      Laya.loader.load(["resources/image/img_btn_bg.png"], Handler19.create(this, () => {
        this.changeActionButton = this.scene.scene2D.addChild(new Button7("resources/image/img_btn_bg.png", "乘骑坐骑"));
    ...
    stypeFun0(label = "乘骑坐骑") {
      ...
      if (this.curStateIndex % 3 == 1) {
        ...
        this.dragon1.transform.localPosition = new Vector314(-0.5, 0, 0);
        this.dragon1.transform.localRotationEuler = new Vector314(0, -180, 100);
        this.animator.play("ride");
      } else if (this.curStateIndex % 3 == 2) {
        ...
        this.dragon2.transform.localPosition = new Vector314(-0.7, 0, 0);
        this.dragon2.transform.localRotationEuler = new Vector314(0, 180, 95);
        this.animator.play("ride");
      } else {
  ...
  BoneLinkSprite3D = __decorateClass([
    regClass153("7eb1f365-4358-4f60-b931-30ca03f975b6", "../src/3D/Animation/BoneLinkSprite3D.ts")
  ], BoneLinkSprite3D);
  ...
  CameraAnimation = __decorateClass([
    regClass154("50c4f116-02b5-4179-8360-c8c58b502952", "../src/3D/Animation/CameraAnimation.ts")
  ], CameraAnimation);
  ...
  MaterialAnimation = __decorateClass([
    regClass155("f2170105-c2c6-437f-8654-18d17eda81a1", "../src/3D/Animation/MaterialAnimation.ts")
  ], MaterialAnimation);
  ...
  RigidbodyAnimationDemo = __decorateClass([
    regClass156("289c86d4-758d-4782-8d77-1bb4ef606829", "../src/3D/Animation/RigidbodyAnimationDemo.ts")
  ...
  var SimpleSkinAnimationInstance = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector315(-16.4, 2.96, 24.3);
      this.camera.transform.localRotationEuler = new Vector315(-7.5, -30, 0);
    ...
    sceneBuild(aniNameIndex) {
      ...
      for (var i = left; i < right; i += this.step)
        for (var j = left; j < right; j += this.step) {
          ...
          var quaterial = new Vector315(0, Math.random() * 180, 0);
          this.cloneSprite(new Vector315(i + xchange, 0, j + zchange), quaterial, aniNameIndex);
        }
    }
  };
  ...
  SimpleSkinAnimationInstance = __decorateClass([
    regClass157("0400feed-d633-46aa-a964-c2d558a53e84", "../src/3D/Animation/SimpleSkinAnimationInstance.ts")
  ...
  var CameraDemo = class extends BaseScript {
    constructor() {
      super();
      this._translate = new Vector316(0, 0.7, 5);
      this._rotation = new Vector316(-15, 0, 0);
      this._rotation2 = new Vector316(-3.14 / 3, 0, 0);
      this._rotation3 = new Vector316(0, 45, 0);
    }
    onAwake() {
      super.base(this.camera);
    ...
    onPreLoadFinish(res) {
      ...
      let meshfilter = box.addComponent(Laya.MeshFilter);
      let meshrender = box.addComponent(Laya.MeshRenderer);
      meshfilter.sharedMesh = mesh;
      this.scene.addChild(box);
      box.transform.position = new Vector316(0, 2.7, 5);
      box.transform.rotate(this._rotation3, false, false);
      var materialBill = new BlinnPhongMaterial2();
      box.getComponent(Laya.MeshRenderer).sharedMaterial = materialBill;
    ...
    setSkybox() {
      ...
      var skyRenderer = this.owner.scene3D.skyRenderer;
  ...
  CameraDemo = __decorateClass([
    regClass158("3ea79b10-8ea8-4553-9cab-cef8f959d4ec", "../src/3D/Camera/CameraDemo.ts")
  ], CameraDemo);
  ...
  var CameraLayer = class extends BaseScript {
    constructor() {
      super();
      this.layerIndex = 0;
      this._translate = new Vector317(0, 1.7, 3);
      this._rotation3 = new Quaternion3(0.7071068, 0, 0, -0.7071067);
      this._rotation4 = new Vector317(0, 60, 0);
      this._position = new Vector317(0, 0, 0.5);
    }
    onAwake() {
      super.base(this.camera);
    ...
    onComplete(res) {
      ...
      let meshfilter = staticLayaMonkey.addComponent(Laya.MeshFilter);
      meshfilter.sharedMesh = res[1];
      let meshrender = staticLayaMonkey.addComponent(Laya.MeshRenderer);
      this.scene.addChild(staticLayaMonkey);
      staticLayaMonkey.getComponent(Laya.MeshRenderer).sharedMaterial = res[2];
      staticLayaMonkey.layer = 1;
      staticLayaMonkey.transform.position = new Vector317(0, 0, 0.5);
      staticLayaMonkey.transform.localScale = new Vector317(0.3, 0.3, 0.3);
      ...
      layaMonkey_clone3.transform.localScale = new Vector317(0.1, 0.1, 0.1);
  ...
  CameraLayer = __decorateClass([
    regClass159("51179047-4ec6-47d8-a8a9-ea1a987f1bb1", "../src/3D/Camera/CameraLayer.ts")
  ], CameraLayer);
  ...
  var CameraLookAt = class extends BaseScript {
    constructor() {
      super();
      this.index = 0;
      this._translate = new Vector318(0, 0.7, 5);
      this._rotation = new Vector318(-15, 0, 0);
      this._rotation2 = new Vector318(-3.14 / 3, 0, 0);
      this._rotation3 = new Vector318(0, 45, 0);
      this._position = new Vector318(1.5, 0, 2);
      this._position2 = new Vector318(-1.5, 0, 2);
      this._position3 = new Vector318(0, 0, 2);
      this._up = new Vector318(0, 1, 0);
    }
    onAwake() {
      super.base(this.camera);
    ...
    onPreLoadFinish() {
      ...
      let boxMesh = PrimitiveMesh2.createBox(0.5, 0.5, 0.5);
      let boxMeshFilter = this.box.addComponent(Laya.MeshFilter);
      let boxMeshRender = this.box.addComponent(Laya.MeshRenderer);
      ...
      let capsuleMesh = PrimitiveMesh2.createCapsule(0.25, 1, 10, 20);
      let capsuleMeshFilter = this.capsule.addComponent(Laya.MeshFilter);
      let capsuleMeshRender = this.capsule.addComponent(Laya.MeshRenderer);
      ...
      let cylinderMesh = PrimitiveMesh2.createCylinder(0.25, 1, 20);
      let cylinderMeshFilter = this.cylinder.addComponent(Laya.MeshFilter);
      let cylinderMeshRender = this.cylinder.addComponent(Laya.MeshRenderer);
  ...
  CameraLookAt = __decorateClass([
    regClass160("50cce2c0-484a-4f78-9669-e9153e3d9dce", "../src/3D/Camera/CameraLookAt.ts")
  ], CameraLookAt);
  ...
  var CameraMSAADemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.camera.transform.position = new Vector319(0, 1, 3);
    ...
    addObjectInScene(scene) {
      ...
      let plane = this.createMeshSprite3D(planeMesh, null);
      scene.addChild(plane);
      let cubeMesh = PrimitiveMesh3.createBox();
      let sphere = PrimitiveMesh3.createSphere(0.3);
      let cube0 = this.createMeshSprite3D(cubeMesh, new BlinnPhongMaterial4());
      let cube1 = this.createMeshSprite3D(cubeMesh, null);
      let cube2 = this.createMeshSprite3D(cubeMesh, null);
      let cube3 = this.createMeshSprite3D(cubeMesh, null);
      let sphere0 = this.createMeshSprite3D(sphere, null);
      let sphere1 = this.createMeshSprite3D(sphere, null);
      let sphere2 = this.createMeshSprite3D(sphere, null);
      let sphere3 = this.createMeshSprite3D(sphere, null);
      ...
      cube1.transform.position = new Vector319(-1, 0, 0);
      cube2.transform.position = new Vector319(-1, 0, 1);
      cube3.transform.position = new Vector319(-1, 1, 0);
      sphere0.transform.position = new Vector319(-3, 0, 0);
      sphere1.transform.position = new Vector319(2, 0, 0);
      sphere2.transform.position = new Vector319(2, 0.5, 0);
      sphere3.transform.position = new Vector319(-1, 0, 2);
    }
    onDestroy() {
  ...
  CameraMSAADemo = __decorateClass([
    regClass161("ff58303b-019f-43f7-91f6-0c9138cf7968", "../src/3D/Camera/CameraMSAADemo.ts")
  ], CameraMSAADemo);
  ...
  var CameraRay = class extends BaseScript {
    constructor() {
      ...
      this._forward = new Vector320(-1, -1, -1);
      this._tilingOffset = new Vector48(10, 10, 0, 0);
      this.tmpVector = new Vector320(0, 0, 0);
      this.tmpVector2 = new Vector320(0, 0, 0);
    }
    createMeshSprite3D(mesh, mat) {
      let sp3d = new Laya.Sprite3D();
      let meshFiler = sp3d.addComponent(Laya.MeshFilter);
    ...
    onAwake() {
      ...
      var plane = this.createMeshSprite3D(PrimitiveMesh4.createPlane(10, 10, 10, 10), null);
      ...
      var planeShape = new BoxColliderShape(10, 0.5, 10);
      planeShape.localOffset = new Laya.Vector3(0, -0.25, 0);
      planeStaticCollider.colliderShape = planeShape;
      planeStaticCollider.friction = 2;
      planeStaticCollider.restitution = 0.3;
      this._ray = new Ray2(new Vector320(0, 0, 0), new Vector320(0, 0, 0));
    ...
    addBoxXYZ(x, y, z) {
      ...
      var box = this.createMeshSprite3D(PrimitiveMesh4.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
  ...
  CameraRay = __decorateClass([
    regClass162("3cda26cf-5b90-48c6-91bd-41a7b4e78f79", "../src/3D/Camera/CameraRay.ts")
  ], CameraRay);
  ...
  D3SpaceToD2Space = __decorateClass([
    regClass163("c6d2764b-c444-41f0-8f03-8530525d9f01", "../src/3D/Camera/D3SpaceToD2Space.ts")
  ], D3SpaceToD2Space);

  // src/3D/Camera/MultiCamera.ts
  var Camera4 = Laya.Camera;
  ...
  var MultiCamera = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector321(0, 0.5, 1.5);
      this.camera.clearColor = new Color5(0.3, 0.3, 0.3, 1);
      this.camera.clearFlag = Laya.CameraClearFlags.SolidColor;
      this.camera.normalizedViewport = new Viewport(0, 0, 0.5, 1);
      var camera2 = this.scene.addChild(new Camera4(0, 0.1, 100));
      camera2.transform.position = new Vector321(0, 0.5, 1.5);
      camera2.transform.rotationEuler = new Vector321(-15, 0, 0);
      camera2.normalizedViewport = new Viewport(0.5, 0, 0.5, 1);
      camera2.clearFlag = CameraClearFlags3.Sky;
      camera2.renderTarget = Index.rt;
      Laya.loader.load("resources/res/threeDimen/skyBox/skyBox2/skyBox2.lmat", Laya.Loader.MATERIAL).then((mat) => {
  ...
  MultiCamera = __decorateClass([
    regClass164("8a04c2c6-169d-435f-9e41-4829041370b4", "../src/3D/Camera/MultiCamera.ts")
  ], MultiCamera);
  ...
  var Orthographicthiscamera = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector322(0, 0.2, 0.7);
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh").then((res) => {
        ...
        layaMonkey.transform.position = new Vector322(0, 0, 0);
      });
  ...
  Orthographicthiscamera = __decorateClass([
    regClass165("87d9c5a0-6c51-4c1b-8e9a-65f2426d4939", "../src/3D/Camera/OrthographicCamera.ts")
  ...
  var PickPixel = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.ray = new Ray3(new Vector323(0, 0, 0), new Vector323(0, 0, 0));
    ...
    onMouseDown(e) {
      ...
      this.camera2.renderTarget.getDataAsync(posX, posY, 1, 1, out).then((out2) => {
        this.text.text = out2[0] + " " + out2[1] + " " + out2[2] + " " + out2[3];
        let r = out2[0].toString(16);
        let g = out2[1].toString(16);
        let b = out2[2].toString(16);
        let color = `#${r}${g}${b}`;
        this._sp.alpha = out2[3] / 255;
  ...
  PickPixel = __decorateClass([
    regClass166("d3e98771-5917-4850-ac70-8ee068dca896", "../src/3D/Camera/PickPixel.ts")
  ], PickPixel);
  ...
  var MouseInteraction = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector324(0, 0.7, 5);
    ...
    onComplete() {
      ...
      grid.layer = 10;
      var staticLayaMonkey = new Laya.Sprite3D();
      let mesh = Loader12.getRes("resources/res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/LayaMonkey-LayaMonkey.lm");
      let moneyMeshfilter = staticLayaMonkey.addComponent(Laya.MeshFilter);
      moneyMeshfilter.sharedMesh = mesh;
      let moneyMeshrender = staticLayaMonkey.addComponent(Laya.MeshRenderer);
      let mat = Loader12.getRes("resources/res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/Materials/T_Diffuse.lmat");
      moneyMeshrender.sharedMaterial = mat;
      this.scene.addChild(staticLayaMonkey);
      staticLayaMonkey.transform.position = new Vector324(0, 0, 0.5);
      staticLayaMonkey.transform.localScale = new Vector324(0.3, 0.3, 0.3);
      staticLayaMonkey.transform.rotation = new Quaternion4(0.7071068, 0, 0, -0.7071067);
      ...
      var scale = new Vector324(0.1, 0.1, 0.1);
      var meshCollider = staticLayaMonkey.addComponent(PhysicsCollider2);
      var meshShape = new MeshColliderShape();
      meshShape.mesh = staticLayaMonkey.getComponent(Laya.MeshFilter).sharedMesh;
      ...
      this.text.y = 50;
      this._ray = new Ray4(new Vector324(0, 0, 0), new Vector324(0, 0, 0));
      this.addMouseEvent();
      this.text.name = "text";
    ...
    onStageMouseDown(e) {
      ...
      this.point.y = e.target.mouseY;
      if (Index.curPage) {
        this.point.x = this.point.x * Index.screenWidth / Index.pageWidth / Laya.stage.width * this.camera.viewport.width / Laya.stage.clientScaleX;
        this.point.y = this.point.y * Index.screenHeight / Index.pageHeight / Laya.stage.height * this.camera.viewport.height / Laya.stage.clientScaleX;
      } else {
  ...
  MouseInteraction = __decorateClass([
    regClass167("5ccea1d7-4091-4a5b-8b15-2abdaed39d1a", "../src/3D/Interaction/MouseInteraction.ts")
  ], MouseInteraction);
  ...
  var MultiTouch = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.directionLight.getComponent(Laya.DirectionLightCom).color.setValue(1, 1, 1, 1);
      this.directionLight.transform.rotate(new Vector325(-3.14 / 3, 0, 0));
      Laya.loader.load("resources/res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh").then((res) => {
        this.onComplete(res);
      });
    }
    onComplete(res) {
      ...
      this.camera.transform.lookAt(monkey.transform.position, new Vector325(0, 1, 0));
  ...
  MultiTouch = __decorateClass([
    regClass168("dd06ebfc-04a2-4fd3-8c94-6ccfdb89ffd4", "../src/3D/Interaction/MultiTouch.ts")
  ], MultiTouch);
  var _MonkeyScript = class _MonkeyScript extends Laya.Script {
    constructor() {
      super(...arguments);
      this.lastPosition = new Vector25(0, 0);
      this.distance = 0;
      this.disVector1 = new Vector25(0, 0);
      this.disVector2 = new Vector25(0, 0);
      this.first = true;
      this.twoFirst = true;
      this.tmpVector = new Vector325(0, 0, 0);
    }
    onAwake() {
    }
    onStart() {
    ...
    onUpdate() {
      ...
      if (1 === touchCount) {
        ...
        if (this.twoFirst) {
          ...
          this.distance = Vector25.scalarLength(this.disVector1);
          this.twoFirst = false;
        } else {
          this.disVector2.x = touch.pos.x - touch2.pos.x;
          this.disVector2.y = touch.pos.y - touch2.pos.y;
          var distance2 = Vector25.scalarLength(this.disVector2);
  ...
  var LODDemo = class extends BaseScript {
    constructor() {
      ...
      this.targetPos = new Laya.Vector3(20.3, 19, 20.6);
  ...
  __decorateClass([
    property168(Laya.VSlider)
  ], LODDemo.prototype, "hSlider", 2);
  __decorateClass([
    property168(Number)
  ], LODDemo.prototype, "speed", 2);
  LODDemo = __decorateClass([
    regClass169("8f4a5998-a1d2-4a48-9184-2337bffd7946", "../src/3D/LOD/LODDemo.ts")
  ], LODDemo);
  ...
  var DirectionLightDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.directionLight.getComponent(Laya.DirectionLightCom).color.setValue(1, 1, 1, 1);
      var mat = this.directionLight.transform.worldMatrix;
      mat.setForward(new Vector326(-1, -1, -1));
      this.directionLight.transform.worldMatrix = mat;
      var resource = [
        "resources/res/threeDimen/staticModel/grid/plane.lh",
    ...
    roll() {
      ...
      Vector326.transformQuat(this._direction, this._quaternion, this._direction);
      var mat = this.directionLight.transform.worldMatrix;
  ...
  DirectionLightDemo = __decorateClass([
    regClass170("c62a7d01-a001-47e8-b09e-9735cf9150db", "../src/3D/Light/DirectionLightDemo.ts")
  ], DirectionLightDemo);
  ...
  LightmapScene = __decorateClass([
    regClass171("405e2005-76bf-4c43-82c8-d1af69cf3061", "../src/3D/Light/LightmapScene.ts")
  ], LightmapScene);
  ...
  var MultiLight = class extends BaseScript {
    ...
    onAwake() {
      ...
      for (var i = 0; i < 15; i++) {
        ...
        spotCom.color = new Laya.Color(Math.random(), Math.random(), Math.random(), 1);
        spotCom.range = 500;
    ...
    updateSpotLights() {
      let time = Laya.timer.currTimer * 15e-4;
  ...
  MultiLight = __decorateClass([
    regClass172("e3509569-515c-4fcd-b7b0-cdf89dc01af5", "../src/3D/Light/MultiLight.ts")
  ], MultiLight);
  ...
  var PointLightDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      var pointLight = this.scene.addChild(new Laya.Sprite3D());
      var pointLightCom = pointLight.addComponent(Laya.PointLightCom);
      pointLightCom.color = new Color6(1, 0.5, 0, 1);
      pointLight.transform.position = new Vector327(0.4, 0.4, 0);
      pointLightCom.range = 3;
      var resource = [
        "resources/res/threeDimen/staticModel/grid/plane.lh",
        "resources/res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh"
      ];
  ...
  PointLightDemo = __decorateClass([
    regClass173("0b10d4a8-5e80-476f-b4ad-26659ca00747", "../src/3D/Light/PointLightDemo.ts")
  ], PointLightDemo);
  ...
  RealTimeShadow = __decorateClass([
    regClass174("c0342e29-ea97-4912-b2a1-7b242ff73181", "../src/3D/Light/RealTimeShadow.ts")
  ], RealTimeShadow);
  ...
  var SpotLightDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      var spotLight = this.scene.addChild(new Laya.Sprite3D());
      var spotLightCom = spotLight.addComponent(Laya.SpotLightCom);
      ...
      spotLightCom.range = 6;
      spotLightCom.spotAngle = 32;
      var resource = [
        "resources/res/threeDimen/staticModel/grid/plane.lh",
        "resources/res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh"
      ];
  ...
  SpotLightDemo = __decorateClass([
    regClass175("8191f8b7-bd56-41d1-bf6e-724ee1cdbe6d", "../src/3D/Light/SpotLightDemo.ts")
  ], SpotLightDemo);
  ...
  var SpotLightShadowMap = class extends BaseScript {
    ...
    receaveRealShadow(scene3d) {
      ...
      for (var i = 0; i < childLength; i++) {
        ...
        let childSpriteCom = childSprite.getComponent(Laya.SpotLightCom);
        if (childSpriteCom) {
          childSpriteCom.shadowMode = ShadowMode2.Hard;
          childSpriteCom.shadowDistance = 3;
          childSpriteCom.shadowResolution = 512;
          childSpriteCom.shadowDepthBias = 1;
        } else {
  ...
  SpotLightShadowMap = __decorateClass([
    regClass176("d2730298-3464-4561-b69e-ac6f409e1038", "../src/3D/Light/SpotLightShadowMap.ts")
  ], SpotLightShadowMap);
  ...
  var BlinnPhongMaterialLoad = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/LayaMonkey-LayaMonkey.lm").then((res) => {
        var layaMonkey = new Laya.Sprite3D();
        let monkeyMeshfilter = layaMonkey.addComponent(Laya.MeshFilter);
        monkeyMeshfilter.sharedMesh = res;
        let monkeyMeshrender = layaMonkey.addComponent(Laya.MeshRenderer);
        this.scene.addChild(layaMonkey);
  ...
  BlinnPhongMaterialLoad = __decorateClass([
    regClass177("54227be2-84b8-4d3f-968a-33281d39294f", "../src/3D/Material/BlinnPhongMaterialLoad.ts")
  ...
  var BlinnPhong_DiffuseMap = class extends BaseScript {
    ...
    onAwake() {
      ...
      earth2Meshrender.sharedMaterial = material;
      Laya.timer.frameLoop(1, this, () => {
  ...
  BlinnPhong_DiffuseMap = __decorateClass([
    regClass178("61db83bc-6e33-4c07-b303-5a7de873bee3", "../src/3D/Material/BlinnPhong_DiffuseMap.ts")
  ...
  var BlinnPhong_NormalMap = class extends BaseScript {
    ...
    onComplete(res) {
      ...
      for (var i = 0; i < monster2.getChildByName("lizard").numChildren; i++) {
        ...
        var material = meshSprite3D.getComponent(MeshRenderer4).sharedMaterial;
        Laya.loader.load(this.normalMapUrl[i]).then((texture) => {
          material.addDefine(Laya.Shader3D.getDefineByName("NORMALMAP"));
  ...
  BlinnPhong_NormalMap = __decorateClass([
    regClass179("8fb78f89-ddaf-487f-a02b-cbfbc870d08a", "../src/3D/Material/BlinnPhong_NormalMap.ts")
  ...
  var BlinnPhong_SpecularMap = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/dude/dude.lh").then((res) => {
        ...
        let mats = skinnedMeshSprite3d.getComponent(SkinnedMeshRenderer).materials;
        ...
        this.addSlider(300, 0.01, 1, 0.07, 0.01, (value) => {
          for (var i2 = 0; i2 < mats.length; i2++) {
            var material2 = mats[i2];
            material2.setFloat("u_Shininess", value);
          }
        });
      });
    }
  ...
  BlinnPhong_SpecularMap = __decorateClass([
    regClass180("70b4a5ec-a309-479e-8321-159ab6f342a6", "../src/3D/Material/BlinnPhong_SpecularMap.ts")
  ...
  var Blinnphong_Transmission = class extends BaseScript {
    ...
    onPreLoadFinish() {
      ...
      this.rabbitMaterial.transmissionColor = new Color8(1, 1, 1, 1);
      ...
      this.monkeyMaterial.transmissionColor = new Color8(0.2, 1, 0, 1);
  ...
  Blinnphong_Transmission = __decorateClass([
    regClass181("de772b6a-4e10-4c52-9378-621b23e856fa", "../src/3D/Material/Blinnphong_Transmission.ts")
  ...
  var EffectMaterialDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      let earthMeshfilter = earth.addComponent(Laya.MeshFilter);
      let earthMeshrender = earth.addComponent(Laya.MeshRenderer);
      let sphereMesh = PrimitiveMesh7.createSphere();
      earthMeshfilter.sharedMesh = sphereMesh;
      ...
      Laya.loader.load("resources/res/threeDimen/texture/earth.png", Laya.Loader.TEXTURE2D).then((texture) => {
        ...
        material.color = new Color9(1, 1, 1, 1);
      });
      earth.getComponent(Laya.MeshRenderer).sharedMaterial = material;
      Laya.timer.frameLoop(1, this, () => {
  ...
  EffectMaterialDemo = __decorateClass([
    regClass182("87076eac-d1a3-472c-8c27-2bdba6ccaa32", "../src/3D/Material/EffectMaterialDemo.ts")
  ], EffectMaterialDemo);
  ...
  var MaterialDemo = class extends BaseScript {
    ...
    onPreLoadFinish() {
      ...
      this.billinMaterial = this.sphere.getComponent(MeshRenderer6).sharedMaterial;
    ...
    change() {
      this.index++;
      if (this.index % 2 === 1) {
        this.sphere.getComponent(MeshRenderer6).sharedMaterial = this.pbrStandardMaterial;
      } else {
        this.sphere.getComponent(MeshRenderer6).sharedMaterial = this.billinMaterial;
      }
    }
  };
  ...
  MaterialDemo = __decorateClass([
    regClass183("c1827786-5bfe-44a2-9cb6-75d7084f93b2", "../src/3D/Material/MaterialDemo.ts")
  ], MaterialDemo);
  ...
  var PBRCoatMaterialDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      const row = 6;
      this.addSpheresSmoothnessMetallic(sphereMesh, new Vector336(0, 1.5, 0), this.scene, 2, 6, new Color10(186 / 255, 110 / 255, 64 / 255, 1));
  ...
  PBRCoatMaterialDemo = __decorateClass([
    regClass184("89f380ef-a603-42b1-bea4-0a77880435de", "../src/3D/Material/PBRCoatMaterialDemo.ts")
  ], PBRCoatMaterialDemo);
  ...
  var PBRMaterialDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      const row = 6;
      this.addSpheresSpecialMetallic(sphereMesh, new Vector337(0, 1.5, 0), this.scene, row, new Color11(186 / 255, 110 / 255, 64 / 255, 1), 1);
      this.addSpheresSmoothnessMetallic(sphereMesh, new Vector337(0, 0, 0), this.scene, 3, row, new Color11(1, 1, 1, 1));
      this.addSpheresSpecialMetallic(sphereMesh, new Vector337(0, -1.5, 0), this.scene, row, new Color11(0, 0, 0, 1), 0);
    }
    /**
     * Add one with smoothness and metallic sphere.
     */
  ...
  PBRMaterialDemo = __decorateClass([
    regClass185("05d3d54e-0e48-467e-ad79-dd0e9eb95d46", "../src/3D/Material/PBRMaterialDemo.ts")
  ], PBRMaterialDemo);
  ...
  var StencilDemo = class extends BaseScript {
    ...
    onPreLoadFinish() {
      ...
      let mat = new UnlitMaterial3();
      mat.albedoColor = new Color12(0.8, 0.5, 0.1);
  ...
  StencilDemo = __decorateClass([
    regClass186("41105c5b-6fc2-4b4c-b2ce-3ef3b9a36ab2", "../src/3D/Material/StencilDemo.ts")
  ], StencilDemo);
  ...
  var UnlitMaterialDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      earth1.getComponent(Laya.MeshRenderer).sharedMaterial = material;
      var material2 = new UnlitMaterial4();
      Laya.loader.load("resources/res/threeDimen/texture/earth.png").then((texture) => {
        material2.albedoTexture = texture;
      });
      earth2.getComponent(Laya.MeshRenderer).sharedMaterial = material2;
      Laya.timer.frameLoop(1, this, () => {
        earth1.transform.rotate(this.rotation, false);
        earth2.transform.rotate(this.rotation, false);
      });
  ...
  UnlitMaterialDemo = __decorateClass([
    regClass187("7c325942-90e6-468a-866c-dafa3682719e", "../src/3D/Material/UnlitMaterialDemo.ts")
  ], UnlitMaterialDemo);
  ...
  var MeshLoad = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector340(0, 0.8, 3.5);
  ...
  __decorateClass([
    property187(Laya.Sprite3D)
  ], MeshLoad.prototype, "directionLight", 2);
  MeshLoad = __decorateClass([
    regClass188("3b0cde81-33ee-4c51-9e5f-19f8ee9bac28", "../src/3D/Mesh/BlendShape.ts")
  ], MeshLoad);
  ...
  ChangeMesh = __decorateClass([
    regClass189("7a9f3e82-8383-4e45-84ce-8900012ca076", "../src/3D/Mesh/ChangeMesh.ts")
  ], ChangeMesh);
  ...
  var CustomMesh = class extends BaseScript {
    ...
    onAwake() {
      ...
      var box = this.createMeshSprite3D(PrimitiveMesh12.createBox(0.5, 0.5, 0.5), null);
      ...
      var boxLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(100));
      Tool.linearModel(box, boxLineSprite3D, Color13.GREEN);
      var sphere = this.createMeshSprite3D(PrimitiveMesh12.createSphere(0.25, 20, 20), null);
      this.sprite3D.addChild(sphere);
      sphere.transform.position = new Vector342(1, 0.25, 0);
      var sphereLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(3500));
      Tool.linearModel(sphere, sphereLineSprite3D, Color13.GREEN);
      var cylinder = this.createMeshSprite3D(PrimitiveMesh12.createCylinder(0.25, 1, 20), null);
      this.sprite3D.addChild(cylinder);
      cylinder.transform.position = new Vector342(0, 0.5, 0);
      var cylinderLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(1e3));
      Tool.linearModel(cylinder, cylinderLineSprite3D, Color13.GREEN);
      var capsule = this.createMeshSprite3D(PrimitiveMesh12.createCapsule(0.25, 1, 10, 20), null);
      this.sprite3D.addChild(capsule);
      capsule.transform.position = new Vector342(-1, 0.5, 0);
      var capsuleLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(3e3));
      Tool.linearModel(capsule, capsuleLineSprite3D, Color13.GREEN);
      var cone = this.createMeshSprite3D(PrimitiveMesh12.createCone(0.25, 0.75), null);
      this.sprite3D.addChild(cone);
      cone.transform.position = new Vector342(-2, 0.375, 0);
      var coneLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(500));
      Tool.linearModel(cone, coneLineSprite3D, Color13.GREEN);
      var plane = this.createMeshSprite3D(PrimitiveMesh12.createPlane(6, 6, 10, 10), null);
      this.sprite3D.addChild(plane);
      var planeLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D2(1e3));
      Tool.linearModel(plane, planeLineSprite3D, Color13.GRAY);
  ...
  CustomMesh = __decorateClass([
    regClass190("4c9dc53e-0e5b-43ef-8b01-430008da119e", "../src/3D/Mesh/CustomMesh.ts")
  ], CustomMesh);
  var _Tool = class _Tool {
    ...
    static DrawBoundingBox(sprite3D, sprite, color) {
      sprite3D.getComponent(Laya.MeshRenderer).bounds.getCorners(_Tool.corners);
    ...
    static DrawTwelveLines(start, end, rotate, sprite3D) {
      ...
      let mesh = PrimitiveMesh12.createCylinder(4e-3, length, 3);
      let meshfilter = cylinder.addComponent(Laya.MeshFilter);
      let meshrender = cylinder.addComponent(Laya.MeshRenderer);
      meshfilter.sharedMesh = mesh;
  ...
  var MeshLoad2 = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/LayaMonkey-LayaMonkey.lm").then((mesh) => {
        ...
        let monkeyMeshfilter = layaMonkey.addComponent(Laya.MeshFilter);
        let monkeyMeshrender = layaMonkey.addComponent(Laya.MeshRenderer);
        monkeyMeshfilter.sharedMesh = mesh;
        ...
        var layaMonkeyLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D3(5e3));
        Tool2.linearModel(layaMonkey, layaMonkeyLineSprite3D, Color14.GREEN);
        var plane = new Laya.Sprite3D();
        let planeMesh = PrimitiveMesh13.createPlane(6, 6, 10, 10);
        let planeMeshfilter = plane.addComponent(Laya.MeshFilter);
        let planeMeshrender = plane.addComponent(Laya.MeshRenderer);
        planeMeshfilter.sharedMesh = planeMesh;
        this.sprite3D.addChild(plane);
        plane.transform.position = new Vector343(0, 0, -1);
        var planeLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D3(1e3));
        Tool2.linearModel(plane, planeLineSprite3D, Color14.GRAY);
        Laya.timer.frameLoop(1, this, () => {
  ...
  MeshLoad2 = __decorateClass([
    regClass191("24ca5702-da0a-4d0b-bb44-8e1bd939c940", "../src/3D/Mesh/MeshLoad.ts")
  ], MeshLoad2);
  var _Tool2 = class _Tool2 {
    static linearModel(sprite3D, lineSprite3D, color) {
      if (sprite3D instanceof Laya.Sprite3D) {
        var meshSprite3D = sprite3D;
        var mesh = meshSprite3D.getComponent(Laya.MeshFilter).sharedMesh;
        var positions = [];
        mesh.getPositions(positions);
    ...
    static DrawBoundingBox(sprite3D, sprite, color) {
      sprite3D.getComponent(Laya.MeshRenderer).bounds.getCorners(_Tool2.corners);
    ...
    static DrawTwelveLines(start, end, rotate, sprite3D) {
      ...
      var cylinder = new Laya.Sprite3D();
      let mesh = PrimitiveMesh13.createCylinder(4e-3, length, 3);
      let meshfilter = cylinder.addComponent(Laya.MeshFilter);
      let meshrender = cylinder.addComponent(Laya.MeshRenderer);
      meshfilter.sharedMesh = mesh;
      sprite3D.addChild(cylinder);
  ...
  Particle_BurningGround = __decorateClass([
    regClass192("5eea8353-e9cb-4b19-b502-9476e37c9539", "../src/3D/Particle/Particle_BurningGround.ts")
  ...
  var Particle_EternalLight = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.camera.clearColor = new Color16(0, 0, 0, 1);
  ...
  Particle_EternalLight = __decorateClass([
    regClass193("d541fe0e-8ad3-4fe5-ad82-88c95454d9b7", "../src/3D/Particle/Particle_EternalLight.ts")
      ...
      Laya.loader.load("resources/res/threeDimen/layabox.png").then((tex) => {
        ...
        for (var i = 0; i < circleCount; i++) {
          ...
          for (var j = 0; j < oneCircleCount; j++) {
            var boxSprite = new Laya.Sprite3D();
            let meshfilter = boxSprite.addComponent(Laya.MeshFilter);
            let meshrender = boxSprite.addComponent(Laya.MeshRenderer);
            meshfilter.sharedMesh = boxMesh;
            meshrender.sharedMaterial = boxMat;
  ...
  DynamicBatchTest = __decorateClass([
    regClass194("05b00a16-ebe7-459a-81d3-ba04127e4f17", "../src/3D/PerformanceTest/DynamicBatchTest.ts")
  ], DynamicBatchTest);
  ...
  StaticBatchingTest = __decorateClass([
    regClass195("0b1e65a6-6e00-4885-b58a-54ae9acbda08", "../src/3D/PerformanceTest/StaticBatchingTest.ts")
  ], StaticBatchingTest);
  ...
  var PhysicsWorld_BaseCollider = class extends BaseScript {
    ...
    onComplete(res) {
      var plane = this.createMeshSprite3D(Laya.PrimitiveMesh.createPlane(20, 20, 10, 10), null);
      this.scene.addChild(plane);
    ...
    addBox() {
      ...
      var box = this.createMeshSprite3D(PrimitiveMesh15.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial9();
      Laya.loader.load("resources/res/threeDimen/Physics/rocks.jpg").then((res) => {
        box.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
    ...
    addSphere() {
      ...
      var sphere = this.createMeshSprite3D(PrimitiveMesh15.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial9();
      Laya.loader.load("resources/res/threeDimen/Physics/plywood.jpg").then((res) => {
        sphere.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
    ...
    addCapsule() {
      ...
      var capsule = this.createMeshSprite3D(PrimitiveMesh15.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial9();
      Laya.loader.load("resources/res/threeDimen/Physics/wood.jpg").then((res) => {
        capsule.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
    ...
    addCone() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var cone = this.createMeshSprite3D(PrimitiveMesh15.createCone(raidius, height), null);
      this.scene.addChild(cone);
      cone.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial9();
      Laya.loader.load("resources/res/threeDimen/Physics/steel2.jpg").then((res) => {
        cone.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
    ...
    addCylinder() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var cylinder = this.createMeshSprite3D(PrimitiveMesh15.createCylinder(raidius, height), null);
      this.scene.addChild(cylinder);
      cylinder.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial9();
      Laya.loader.load("resources/res/threeDimen/Physics/steel.jpg").then((res) => {
        cylinder.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
  ...
  PhysicsWorld_BaseCollider = __decorateClass([
    regClass196("3f74ca02-f4fc-4548-8292-63f8adf9ccde", "../src/3D/PhysicsWorld/PhysicsWorld_BaseCollider.ts")
  ...
  var PhysicsWorld_BuildingBlocks = class extends BaseScript {
    constructor() {
      super();
      this.ray = new Ray5(new Vector346(0, 0, 0), new Vector346(0, 0, 0));
      this.point = new Vector26();
      this._outHitResult = new HitResult3();
    ...
    onComplete(res) {
      ...
      this.directionLight.transform.worldMatrix = mat;
      var plane = this.createMeshSprite3D(PrimitiveMesh16.createPlane(13, 13, 10, 10), null);
      this.scene.addChild(plane);
      var planeMat = new BlinnPhongMaterial10();
      planeMat.albedoTexture = res[0];
      planeMat.tilingOffset = new Vector410(2, 2, 0, 0);
      plane.getComponent(Laya.MeshRenderer).sharedMaterial = planeMat;
      plane.getComponent(Laya.MeshRenderer).receiveShadow = true;
    ...
    addHorizontalBox(x, y, z) {
      var box = this.createMeshSprite3D(this.mesh1, null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat;
      box.getComponent(Laya.MeshRenderer).castShadow = true;
      box.getComponent(Laya.MeshRenderer).receiveShadow = true;
    ...
    addVerticalBox(x, y, z) {
      var box = this.createMeshSprite3D(this.mesh2, null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat;
      box.getComponent(Laya.MeshRenderer).castShadow = true;
      box.getComponent(Laya.MeshRenderer).receiveShadow = true;
    ...
    addMouseEvent() {
      this.owner.on(Event47.MOUSE_DOWN, this, this.onMouseDown);
      this.owner.on(Event47.MOUSE_UP, this, this.onMouseUp);
      this.owner.on(Event47.MOUSE_OUT, this, this.onMouseOut);
    }
    onMouseDown(e) {
      if (Index.curPage) {
        this.posX = this.point.x = e.target.mouseX * Index.screenWidth / Index.pageWidth / Laya.stage.width * this.camera.viewport.width / Laya.stage.clientScaleX;
        this.posY = this.point.y = e.target.mouseY * Index.screenHeight / Index.pageHeight / Laya.stage.height * this.camera.viewport.height / Laya.stage.clientScaleX;
      } else {
        this.posX = this.point.x = e.target.mouseX;
        this.point.y = this.point.y = e.target.mouseY;
      }
      ...
      this.owner.on(Event47.MOUSE_MOVE, this, this.onMouseMove);
    }
    onMouseMove(e) {
      if (Index.curPage) {
    ...
    onMouseUp(e) {
      this.owner.off(Event47.MOUSE_MOVE, this, this.onMouseMove);
      if (this.hasSelectedSprite) {
  ...
  PhysicsWorld_BuildingBlocks = __decorateClass([
    regClass197("bff20f3d-f89d-431c-a225-c6962910008d", "../src/3D/PhysicsWorld/PhysicsWorld_BuildingBlocks.ts")
  ...
  var PhysicsWorld_Character = class extends BaseScript {
    ...
    addBox() {
      ...
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(Laya.PrimitiveMesh.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat1;
    ...
    addCapsule() {
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(Laya.PrimitiveMesh.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat2;
  ...
  PhysicsWorld_Character = __decorateClass([
    regClass198("20248bc4-a0e2-43b8-aa4c-b90c988dfbdf", "../src/3D/PhysicsWorld/PhysicsWorld_Character.ts")
  ...
  var PhysicsWorld_CollisionFiflter = class extends BaseScript {
    constructor() {
      ...
      this._albedoColor = new Color17(1, 0, 0, 1);
    }
    onAwake() {
      super.base(this.camera);
      ...
      this.directionLight.transform.worldMatrix = mat;
      this.plane = this.createMeshSprite3D(PrimitiveMesh17.createPlane(20, 20, 10, 10), null);
      ...
      this.plane.getComponent(Laya.MeshRenderer).sharedMaterial = planeMat;
    ...
    addKinematicSphere() {
      ...
      var radius = 0.8;
      var sphere = this.createMeshSprite3D(PrimitiveMesh17.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = mat2;
      var pos = sphere.transform.position;
    ...
    addBox() {
      ...
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(PrimitiveMesh17.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial11();
      Laya.loader.load("resources/res/threeDimen/Physics/rocks.jpg").then((res) => {
        box.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var transform = box.transform;
    ...
    addCapsule() {
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(PrimitiveMesh17.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial11();
      Laya.loader.load("resources/res/threeDimen/Physics/wood.jpg").then((res) => {
        capsule.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var transform = capsule.transform;
    ...
    addCone() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var cone = this.createMeshSprite3D(PrimitiveMesh17.createCone(raidius, height), null);
      this.scene.addChild(cone);
      cone.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial11();
      Laya.loader.load("resources/res/threeDimen/Physics/steel2.jpg").then((res) => {
        cone.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
    ...
    addCylinder() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var cylinder = this.createMeshSprite3D(PrimitiveMesh17.createCylinder(raidius, height), null);
      this.scene.addChild(cylinder);
      cylinder.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial11();
      Laya.loader.load("resources/res/threeDimen/Physics/steel.jpg").then((res) => {
        cylinder.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var transform = cylinder.transform;
    ...
    addSphere() {
      ...
      var sphere = this.createMeshSprite3D(PrimitiveMesh17.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial11();
      Laya.loader.load("resources/res/threeDimen/Physics/plywood.jpg").then((res) => {
        sphere.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var pos = sphere.transform.position;
  ...
  PhysicsWorld_CollisionFiflter = __decorateClass([
    regClass199("a45b1a31-9a36-4154-b987-246e1b1fb8b3", "../src/3D/PhysicsWorld/PhysicsWorld_CollisionFiflter.ts")
  ...
  var PhysicsWorld_CompoundCollider = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.directionLight.transform.worldMatrix = mat;
      var plane = this.createMeshSprite3D(PrimitiveMesh18.createPlane(20, 20, 20, 10), null);
      this.scene.addChild(plane);
    ...
    addTable() {
      ...
      Laya.loader.load("resources/res/threeDimen/Physics/table.lm").then((res) => {
        var table = this.createMeshSprite3D(res, null);
        this.scene.addChild(table);
        table.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
    ...
    addObject() {
      ...
      Laya.loader.load("resources/res/threeDimen/Physics/object.lm").then((res) => {
        var object = this.createMeshSprite3D(res, null);
        ...
        transform.setWorldLossyScale(scale);
        object.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
  ...
  PhysicsWorld_CompoundCollider = __decorateClass([
    regClass200("16ff281f-5149-414e-b707-2cfd0d770f48", "../src/3D/PhysicsWorld/PhysicsWorld_CompoundCollider.ts")
  ...
  var PhysicsWorld_ConfigurableJoint = class extends BaseScript {
    ...
    onStart() {
      ...
      this.directionLight.transform.worldMatrix = mat;
      var plane = this.createMeshSprite3D(PrimitiveMesh19.createPlane(40, 40, 40, 40), null);
      this.scene.addChild(plane);
    ...
    springTest() {
      ...
      boxB.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color18(1, 0, 0, 1);
    ...
    freeRotate() {
      ...
      boxBRigid.angularVelocity = new Vector350(2, 2, 2);
    ...
    addRigidBodyBox(pos, scale) {
      var box = this.createMeshSprite3D(PrimitiveMesh19.createBox(scale, scale, scale), null);
      this.scene.addChild(box);
    ...
    addRigidBodySphere(pos, scale) {
      var sphere = this.createMeshSprite3D(PrimitiveMesh19.createSphere(0.2), null);
      this.scene.addChild(sphere);
      sphere.transform.position = pos;
      var mat = new BlinnPhongMaterial13();
      mat.albedoColor = new Color18(0, 1, 0, 1);
  ...
  PhysicsWorld_ConfigurableJoint = __decorateClass([
    regClass201("8a0ef41e-764f-4da2-976d-16a30f0f7618", "../src/3D/PhysicsWorld/PhysicsWorld_ConfigurableJoint.ts")
  ...
  var PhysicsWorld_ConstraintFixedJoint = class extends BaseScript {
    ...
    addbox() {
      var box = this.createMeshSprite3D(PrimitiveMesh20.createBox(1, 1, 1), null);
      this.scene.addChild(box);
      var transform = box.transform;
      var pos = transform.position;
      pos.setValue(0, 5, 0);
      transform.position = pos;
      box.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial14();
      var rigidBody = box.addComponent(Rigidbody3D7);
      var boxShape = new BoxColliderShape7(1, 1, 1);
      rigidBody.colliderShape = boxShape;
      rigidBody.mass = 10;
      rigidBody.isKinematic = true;
      var box2 = this.createMeshSprite3D(PrimitiveMesh20.createBox(1, 1, 1), null);
      this.scene.addChild(box2);
      var transform2 = box2.transform;
      var pos2 = transform2.position;
      pos2.setValue(0, 3, 0);
      transform2.position = pos2;
      box2.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial14();
      ...
      Laya.loader.load("resources/res/threeDimen/texture/layabox.png").then((tex) => {
        ...
        box.getComponent(Laya.MeshRenderer).sharedMaterial = blinnMat;
        box2.getComponent(Laya.MeshRenderer).sharedMaterial = blinnMat;
      });
  ...
  PhysicsWorld_ConstraintFixedJoint = __decorateClass([
    regClass202("1e8563cf-8f4b-4799-a982-ac5f521833f1", "../src/3D/PhysicsWorld/PhysicsWorld_ConstraintFixedJoint.ts")
  ], PhysicsWorld_ConstraintFixedJoint);
  var _FixedEventTest = class _FixedEventTest extends Laya.Script {
    constructor() {
      super(...arguments);
      this._addForce = new Laya.Vector3();
      this._addForceCenter = new Laya.Vector3(0, 0, 0);
    }
    onStart() {
    ...
    onUpdate() {
      if (this.fixedConstraint) {
        if (window.PHYSX) {
          this._addForce.setValue(this._addForce.x, this._addForce.y -= 10, this._addForce.z);
          this.fixedConstraint.connectedBody.applyForce(this._addForce, this._addForceCenter);
        } else {
  ...
  var PhysicsWorld_ContinueCollisionDetection = class extends BaseScript {
    ...
    onComplete(res) {
      var plane = this.createMeshSprite3D(PrimitiveMesh21.createPlane(20, 20, 10, 10), null);
      this.scene.addChild(plane);
    ...
    addSphere() {
      var radius = Math.random() * 0.2 + 0.2;
      var sphere = this.createMeshSprite3D(PrimitiveMesh21.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial15();
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = Laya.Loader.getRes("resources/res/threeDimen/Physics/plywood.jpg");
      var pos = sphere.transform.position;
      pos.setValue(Math.random() * 4 - 2, 10, Math.random() * 4 - 2);
      sphere.transform.position = pos;
      var rigidBody = sphere.addComponent(Rigidbody3D8);
      var sphereShape = new SphereColliderShape5(radius);
      rigidBody.gravity = new Vector352(0, -98, 0);
      rigidBody.colliderShape = sphereShape;
      rigidBody.mass = 10;
    }
  };
  ...
  PhysicsWorld_ContinueCollisionDetection = __decorateClass([
    regClass203("bb67b7fe-1ca5-4657-b7dc-fafd67ab7546", "../src/3D/PhysicsWorld/PhysicsWorld_ContinueCollisionDetection.ts")
  ...
  var PhysicsWorld_Kinematic = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.plane = this.createMeshSprite3D(PrimitiveMesh22.createPlane(20, 20, 10, 10), null);
      this.scene.addChild(this.plane);
    ...
    addKinematicSphere() {
      ...
      var radius = 0.8;
      var sphere = this.createMeshSprite3D(PrimitiveMesh22.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = mat2;
      var pos = sphere.transform.position;
      pos.setValue(0, 0.8, 0);
    ...
    addBox() {
      ...
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(PrimitiveMesh22.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat1;
      var transform = box.transform;
      var pos = transform.position;
    ...
    addCapsule() {
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(PrimitiveMesh22.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = this.mat3;
      var transform = capsule.transform;
      var pos = transform.position;
      pos.setValue(Math.random() * 4 - 2, 2, Math.random() * 4 - 2);
      transform.position = pos;
  ...
  PhysicsWorld_Kinematic = __decorateClass([
    regClass204("92276d17-d5a1-4c38-8fe6-76e0770c3526", "../src/3D/PhysicsWorld/PhysicsWorld_Kinematic.ts")
  ...
  var PhysicsWorld_MeshCollider = class extends BaseScript {
    ...
    complete() {
      var mesh = Loader17.getRes("resources/res/threeDimen/staticModel/lizard/Assets/Lizard/lizard-lizard_geo.lm");
      var albedo = Loader17.getTexture2D("resources/res/threeDimen/staticModel/lizard/Assets/Lizard/lizard_diff.png");
      var normal = Loader17.getTexture2D("resources/res/threeDimen/staticModel/lizard/Assets/Lizard/lizard_norm.png");
      var mat = new BlinnPhongMaterial17();
      mat.specularColor = new Color19(0.5, 0.5, 0.5, 0.5);
      mat.albedoTexture = albedo;
      mat.normalTexture = normal;
      var lizard = this.createMeshSprite3D(mesh, null);
      this.scene.addChild(lizard);
      lizard.transform.localPosition = new Vector354(-2, 0, 0);
      lizard.transform.localScale = new Vector354(0.01, 0.01, 0.01);
      lizard.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
      ...
      var lizard1 = this.createMeshSprite3D(mesh, null);
      this.scene.addChild(lizard1);
      ...
      lizard1.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
    ...
    addBox() {
      ...
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(PrimitiveMesh23.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial17();
      Laya.loader.load("resources/res/threeDimen/Physics/rocks.jpg").then((res) => {
        box.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var transform = box.transform;
    ...
    addSphere() {
      var radius = Math.random() * 0.2 + 0.2;
      var sphere = this.createMeshSprite3D(PrimitiveMesh23.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial17();
      Laya.loader.load("resources/res/threeDimen/Physics/plywood.jpg").then((res) => {
        sphere.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var pos = sphere.transform.position;
    ...
    addCapsule() {
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(PrimitiveMesh23.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = new BlinnPhongMaterial17();
      Laya.loader.load("resources/res/threeDimen/Physics/wood.jpg").then((res) => {
        capsule.getComponent(Laya.MeshRenderer).sharedMaterial.albedoTexture = res;
      });
      var transform = capsule.transform;
  ...
  PhysicsWorld_MeshCollider = __decorateClass([
    regClass205("69c44b4c-3843-4260-8186-6b30c2038b01", "../src/3D/PhysicsWorld/PhysicsWorld_MeshCollider.ts")
  ...
  var PhysicsWorld_RayShapeCast = class extends BaseScript {
    constructor() {
      ...
      this.castType = 0;
      this.castAll = false;
      this.ray = new Ray6(new Vector355(0, 0, 0), new Vector355(0, 0, 0));
      this.hitResult = new HitResult4();
      this.hitResults = [];
      this.debugSprites = [];
      //创建射线的起始点
      this.from = new Vector355(0, 1, 10);
      this.to = new Vector355(0, 1, -5);
      this.rayDir = new Vector355(0, 0, -1);
      this._albedoColor = new Color20(1, 1, 1, 0.5);
    ...
    onAwake() {
      ...
      this.directionLight.transform.worldMatrix = mat;
      var plane = this.createMeshSprite3D(PrimitiveMesh24.createPlane(20, 20, 10, 10), null);
      this.scene.addChild(plane);
    ...
    loadUI() {
      this.changeActionButton0 = this.owner.addChild(new Button8("resources/image/img_btn_bg.png", "射线模式"));
      ...
      this.changeActionButton0.on(Event48.CLICK, this, this.stypeFun0);
      this.changeActionButton1 = this.owner.addChild(new Button8("resources/image/img_btn_bg.png", "不穿透"));
      ...
      this.changeActionButton1.on(Event48.CLICK, this, this.stypeFun1);
      this.changeActionButton2 = this.owner.addChild(new Button8("resources/image/img_btn_bg.png", "检测"));
      ...
      this.changeActionButton2.on(Event48.CLICK, this, this.stypeFun2);
    }
    ...
    stypeFun2(castType = 0) {
      if (this.hitResult.succeeded)
        this.hitResult.collider.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color20(1, 1, 1, 1);
      if (this.hitResults.length > 0) {
        for (var i = 0, n = this.hitResults.length; i < n; i++)
          this.hitResults[i].collider.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color20(1, 1, 1, 1);
      ...
      switch (this.castType) {
        case 0:
          var lineSprite = this.scene.addChild(new PixelLineSprite3D4(1));
          lineSprite.addLine(this.from, this.to, Color20.RED, Color20.RED);
          ...
          if (this.castAll) {
            ...
            for (i = 0, n = this.hitResults.length; i < n; i++)
              this.hitResults[i].collider.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color20(1, 0, 0, 1);
          } else {
            this.scene.physicsSimulation.rayCast(this.ray, this.hitResult);
            this.hitResult.collider.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color20(1, 0, 0, 1);
          }
          break;
        case 1:
          var boxCollider = new BoxColliderShape11(1, 1, 1);
          for (i = 0; i < 21; i++) {
            var boxSprite = this.createMeshSprite3D(PrimitiveMesh24.createBox(1, 1, 1), null);
            this.scene.addChild(boxSprite);
            ...
            boxSprite.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
          ...
          if (this.castAll) {
            ...
            if (this.scene.physicsSimulation.shapeCast(boxCollider.shape, this.from, this.to, this.hitResult))
              this.hitResult.collider.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color20(1, 0, 0, 1);
          }
          break;
        case 2:
          ...
          for (i = 0; i < 41; i++) {
            var sphereSprite = this.createMeshSprite3D(PrimitiveMesh24.createSphere(0.5), null);
            this.scene.addChild(sphereSprite);
            var mat = new BlinnPhongMaterial18();
            mat.albedoColor = this._albedoColor;
            mat.renderMode = BlinnPhongMaterial18.RENDERMODE_TRANSPARENT;
            sphereSprite.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
        ...
        case 3:
          ...
          for (i = 0; i < 41; i++) {
            var capsuleSprite = this.createMeshSprite3D(PrimitiveMesh24.createCapsule(0.25, 1), null);
            this.scene.addChild(capsuleSprite);
            var mat = new BlinnPhongMaterial18();
            mat.albedoColor = this._albedoColor;
            mat.renderMode = BlinnPhongMaterial18.RENDERMODE_TRANSPARENT;
            capsuleSprite.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
            Vector355.lerp(this.from, this.to, i / 40, this._position);
    ...
    addBox() {
      ...
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(PrimitiveMesh24.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = mat1;
      var transform = box.transform;
      var pos = transform.position;
      pos.setValue(Math.random() * 4 - 2, 2, Math.random() * 4 - 2);
      transform.position = pos;
    ...
    addCapsule() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(PrimitiveMesh24.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
  ...
  PhysicsWorld_RayShapeCast = __decorateClass([
    regClass206("28020748-173b-4117-922d-04dc28e79f78", "../src/3D/PhysicsWorld/PhysicsWorld_RayShapeCast.ts")
  ...
  PhysicsWorld_Rigidbody3DBounce = __decorateClass([
    regClass207("71cf8471-039f-4cd0-8359-f6f0d02a487b", "../src/3D/PhysicsWorld/PhysicsWorld_Rigidbody3DBounce.ts")
  ...
  PhysicsWorld_Rigidbody3DFriction = __decorateClass([
    regClass208("d5895c58-3e96-478d-a991-34cd217aedce", "../src/3D/PhysicsWorld/PhysicsWorld_Rigidbody3DFriction.ts")
  ...
  var PhysicsWorld_TriggerAndCollisionEvent = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.directionLight.transform.worldMatrix = mat;
      this.plane = this.createMeshSprite3D(PrimitiveMesh25.createPlane(20, 20, 10, 10), null);
      this.scene.addChild(this.plane);
    ...
    addKinematicSphere() {
      ...
      mat2.albedoColor = new Color21(1, 0, 0, 1);
      var radius = 0.8;
      var sphere = this.createMeshSprite3D(PrimitiveMesh25.createSphere(radius), null);
      this.scene.addChild(sphere);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = mat2;
      var pos = sphere.transform.position;
      pos.setValue(0, 0.8, 0);
      ...
      var sphereShape = new SphereColliderShape8(radius);
      rigidBody.colliderShape = sphereShape;
      rigidBody.mass = 60;
      rigidBody.isKinematic = true;
      this.kinematicSphere = sphere;
    ...
    addBoxAndTrigger() {
      ...
      mat1.albedoColor = new Color21(1, 1, 1, 1);
      var sX = Math.random() * 0.75 + 0.25;
      var sY = Math.random() * 0.75 + 0.25;
      var sZ = Math.random() * 0.75 + 0.25;
      var box = this.createMeshSprite3D(PrimitiveMesh25.createBox(sX, sY, sZ), null);
      this.scene.addChild(box);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = mat1;
      var transform = box.transform;
      var pos = transform.position;
    ...
    addCapsuleCollision() {
      ...
      var raidius = Math.random() * 0.2 + 0.2;
      var height = Math.random() * 0.5 + 0.8;
      var capsule = this.createMeshSprite3D(PrimitiveMesh25.createCapsule(raidius, height), null);
      this.scene.addChild(capsule);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = mat3;
      var transform = capsule.transform;
      var pos = transform.position;
      pos.setValue(Math.random() * 4 - 2, 2, Math.random() * 4 - 2);
      transform.position = pos;
  ...
  PhysicsWorld_TriggerAndCollisionEvent = __decorateClass([
    regClass209("4d873f7e-4cd7-4613-bca4-fd2851da4301", "../src/3D/PhysicsWorld/PhysicsWorld_TriggerAndCollisionEvent.ts")
  ...
  var _TriggerCollisionScript = class _TriggerCollisionScript extends Laya.Script {
    ...
    onTriggerEnter(other) {
      this.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color21(0, 1, 0, 1);
    }
    //持续触发时执行
    onTriggerStay(other) {
    }
    //结束触发时执行
    onTriggerExit(other) {
      this.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color21(1, 1, 1, 1);
    }
    //开始碰撞时执行
    onCollisionEnter(collision) {
      if (collision.other.owner === this.kinematicSprite)
        this.owner.getComponent(Laya.MeshRenderer).sharedMaterial.albedoColor = new Color21(0, 0, 0, 1);
    }
    //持续碰撞时执行
  ...
  PostProcessAO = __decorateClass([
    regClass210("2cf6cd82-fb9a-4533-9cab-4f56553644d5", "../src/3D/PostProcess/PostProcessAO.ts")
  ], PostProcessAO);
  ...
  PostProcessBloom = __decorateClass([
    regClass211("42295c88-4869-49a6-80ce-44c4e80ce451", "../src/3D/PostProcess/PostProcessBloom.ts")
  ], PostProcessBloom);
  ...
  PostProcessDoF = __decorateClass([
    regClass212("ead5a66a-5863-4576-b5f0-2a010dd56bfa", "../src/3D/PostProcess/PostProcessDoF.ts")
  ], PostProcessDoF);
  ...
  PostProcess_Blur = __decorateClass([
    regClass213("9eb21397-579f-4799-b104-b539e9971d86", "../src/3D/PostProcess/PostProcess_Blur.ts")
  ], PostProcess_Blur);
  ...
  var _BlurMaterial2 = class _BlurMaterial2 extends Material4 {
    ...
    constructor(texelSize, offset) {
      ...
      this.setShaderName("blurEffect");
      this.setFloatByIndex(_BlurMaterial2.SHADERVALUE_DOWNSAMPLEVALUE, offset);
  ...
  var PostProcess_Edge = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.addLight();
      Laya.loader.load("resources/res/threeDimen/skinModel/dude/dude.lh").then((res) => {
        let sphere = this.createMeshSprite3D(PrimitiveMesh26.createSphere(1), null);
        sphere.name = "Sphere";
        this.scene.addChild(sphere);
        sphere.transform.position = new Vector357(0, 1, 0);
        let plane = this.createMeshSprite3D(PrimitiveMesh26.createPlane(), null);
        plane.name = "Plane";
        this.scene.addChild(plane);
        plane.transform.position = new Vector357(0, -0.5, 0);
        let cube = this.createMeshSprite3D(PrimitiveMesh26.createBox(1, 1, 1), null);
        cube.name = "Cube";
    ...
    addLight() {
      ...
      let lightColor = new Color22(0.6, 0.6, 0.6);
    ...
    addButton(x, y, width, height, text, size, clickFunc) {
      let button = this.owner.addChild(new Button9("resources/image/img_btn_bg.png", text));
      ...
      button.pos(x, y);
      button.on(Event49.CLICK, this, clickFunc);
      return button;
    }
  ...
  PostProcess_Edge = __decorateClass([
    regClass214("f610bff8-ef8b-40b7-bf5d-5419c36a45cb", "../src/3D/PostProcess/PostProcess_Edge.ts")
  ], PostProcess_Edge);
  ...
  var _EdgeEffect = class _EdgeEffect extends PostProcessEffect2 {
    constructor() {
      super();
      this._shader = null;
      this._shaderData = LayaGL2.renderDeviceFactory.createShaderData(null);
    ...
    static EdgeEffectShaderInit() {
      ...
      let uniformMap = {
        ...
        "u_EdgeColor": ShaderDataType4.Vector3,
  ...
  var PostProcess_LensFlare = class extends BaseScript {
    ...
    onEnable() {
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/dude/dude.lh").then(() => {
        var dude = this.scene.addChild(Laya.Loader.createNodes("resources/res/threeDimen/skinModel/dude/dude.lh"));
  ...
  PostProcess_LensFlare = __decorateClass([
    regClass215("dba9edb7-80ba-4d0f-ab04-5eb70bff5438", "../src/3D/PostProcess/PostProcess_LensFlare.ts")
  ...
  var GarbageCollection = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      Scene3D2.load("resources/res/threeDimen/scene/LayaScene_dudeScene/Conventional/dudeScene.ls", Handler21.create(this, (scene) => {
  ...
  GarbageCollection = __decorateClass([
    regClass216("dfc7da98-20e0-474c-a6df-4fbab1af1a8f", "../src/3D/Resource/GarbageCollection.ts")
  ], GarbageCollection);
    ...
    onAwake() {
      ...
      Laya.loader.load(Resource2).then((res) => {
        ...
        Laya.loader.load("resources/res/threeDimen/fbx/LayaMonkey.FBX", Loader18.HIERARCHY).then((fbx) => {
          ...
          LayaMonkey.getChildAt(0).getComponent(Laya.MeshRenderer).sharedMaterial = res[3];
        });
      });
    }
    onFBXComplete(res) {
      ...
      Stand.getChildAt(0).getComponent(Laya.MeshRenderer).sharedMaterial = res[2];
    }
  };
  ...
  LoadFbxRosource = __decorateClass([
    regClass217("97f3fc07-f23a-40f7-9b00-346bbca95ac5", "../src/3D/Resource/LoadFbxRosource.ts")
  ], LoadFbxRosource);
  ...
  LoadGltfRosource = __decorateClass([
    regClass218("94f58eab-aae6-4322-94c4-dd6654f2317a", "../src/3D/Resource/LoadGltfRosource.ts")
  ], LoadGltfRosource);
  ...
  var LoadResourceDemo = class extends BaseScript {
    ...
    onComplete(res) {
      ...
      var earth1 = this.createMeshSprite3D(PrimitiveMesh27.createSphere(1), null);
      this.scene.addChild(earth1);
      earth1.transform.position = new Laya.Vector3(0, 1, 0);
      var earthMat = new BlinnPhongMaterial20();
      earthMat.albedoTexture = res[1];
      earthMat.albedoIntensity = 1;
      earth1.getComponent(Laya.MeshRenderer).sharedMaterial = earthMat;
      var layaMonkey = this.createMeshSprite3D(res[2], null);
      this.scene.addChild(layaMonkey);
  ...
  __decorateClass([
    property218(Laya.ProgressBar)
  ], LoadResourceDemo.prototype, "loadingBar", 2);
  LoadResourceDemo = __decorateClass([
    regClass219("dcc04071-d471-438c-933e-bfc361ac03a4", "../src/3D/Resource/LoadResourceDemo.ts")
  ], LoadResourceDemo);
  ...
  var EnvironmentalReflection = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/threeDimen/staticModel/teapot/teapot-Teapot001.lm").then((res) => {
        this.teapot = this.createMeshSprite3D(res, null);
        this.scene.addChild(this.teapot);
        ...
        pbrMat.metallic = 1;
        pbrMat.smoothness = 1;
        this.teapot.getComponent(Laya.MeshRenderer).sharedMaterial = pbrMat;
      });
  ...
  EnvironmentalReflection = __decorateClass([
    regClass220("d610a4a9-c75b-463a-a39a-848d8fa1ff89", "../src/3D/Scene3D/EnvironmentalReflection.ts")
  ...
  __decorateClass([
    property220({ type: Laya.Camera })
  ], FogScene.prototype, "camera", 2);
  __decorateClass([
    property220({ type: Laya.Scene3D })
  ], FogScene.prototype, "scene", 2);
  __decorateClass([
    property220({ type: Laya.VSlider })
  ], FogScene.prototype, "slider", 2);
  __decorateClass([
    property220(Number)
  ], FogScene.prototype, "speed", 2);
  __decorateClass([
    property220({ type: Laya.Button })
  ], FogScene.prototype, "fogEnableBTN", 2);
  FogScene = __decorateClass([
    regClass221("c9c2bea8-c9a8-4977-a02d-2e9cffffed16", "../src/3D/Scene3D/FogScene.ts")
  ], FogScene);
  ...
  var GriendSkyAmbientDemo = class extends BaseScript {
    ...
    onAwake() {
      ...
      var box = this.createMeshSprite3D(PrimitiveMesh28.createBox(0.5, 0.5, 0.5), null);
      this.sprite3D.addChild(box);
      box.transform.position = new Vector362(2, 0.25, 0.6);
      box.transform.rotate(new Vector362(0, 45, 0), false, false);
      box.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
      var sphere = this.createMeshSprite3D(PrimitiveMesh28.createSphere(0.25, 20, 20), null);
      this.sprite3D.addChild(sphere);
      sphere.transform.position = new Vector362(1, 0.25, 0.6);
      sphere.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
      var cylinder = this.createMeshSprite3D(PrimitiveMesh28.createCylinder(0.25, 1, 20), null);
      this.sprite3D.addChild(cylinder);
      cylinder.transform.position = new Vector362(0, 0.5, 0.6);
      cylinder.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
      var capsule = this.createMeshSprite3D(PrimitiveMesh28.createCapsule(0.25, 1, 10, 20), null);
      this.sprite3D.addChild(capsule);
      capsule.transform.position = new Vector362(-1, 0.5, 0.6);
      capsule.getComponent(Laya.MeshRenderer).sharedMaterial = mat;
      var cone = this.createMeshSprite3D(PrimitiveMesh28.createCone(0.25, 0.75), null);
      this.sprite3D.addChild(cone);
  ...
  GriendSkyAmbientDemo = __decorateClass([
    regClass222("a938acc9-7759-4f01-b580-ebd51eacad0b", "../src/3D/Scene3D/GriendSkyAmbientDemo.ts")
  ...
  __decorateClass([
    property222(Laya.ProgressBar)
  ], SceneLoad1.prototype, "loadingBar", 2);
  SceneLoad1 = __decorateClass([
    regClass223("c6173b46-e841-4b3b-a762-0b55d1184ee8", "../src/3D/Scene3D/SceneLoad1.ts")
  ], SceneLoad1);
  ...
  var ScriptDemo = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      var box = this.createMeshSprite3D(Laya.PrimitiveMesh.createBox(1, 1, 1), null);
      box.name = "MOs";
      this.scene.addChild(box);
      box.transform.rotate(new Laya.Vector3(0, 45, 0), false, false);
      var material = new Laya.BlinnPhongMaterial();
      box.getComponent(Laya.MeshRenderer).sharedMaterial = material;
  ...
  ScriptDemo = __decorateClass([
    regClass224("a9f82f8b-3ad9-4e61-9728-ecb2a33b85b4", "../src/3D/Script/ScriptDemo.ts")
  ], ScriptDemo);
  ...
  var Shader_GlowingEdge = class extends BaseScript {
    ...
    onComplete(res) {
      ...
      dude.getChildAt(0).getChildAt(0).getComponent(Laya.SkinnedMeshRenderer).sharedMaterials = baseMaterials;
      ...
      var earth = this.createMeshSprite3D(PrimitiveMesh29.createSphere(0.5, 128, 128), null);
      scene.addChild(earth);
      var glowingEdgeMaterial = new GlowingEdgeMaterial();
      glowingEdgeMaterial.diffuseTexture = res[5];
      earth.getComponent(Laya.MeshRenderer).sharedMaterial = glowingEdgeMaterial;
  ...
  Shader_GlowingEdge = __decorateClass([
    regClass225("e882ec65-5502-4ad4-ac29-9d77e3d022b7", "../src/3D/Shader/Shader_GlowingEdge.ts")
  ], Shader_GlowingEdge);
  ...
  var outline_default = '// 原来的写法会被我们自己的解析流程处理，而我们的解析是不认内置宏的，导致被删掉，所以改成 if defined 了\r\n#if defined(GL_FRAGMENT_PRECISION_HIGH)\r\n    precision highp float; \r\n#else \r\n    precision mediump float; \r\n#endif \r\n\r\n#include "Color.glsl";\r\n\r\n\r\nvoid main() \r\n{ \r\n    vec3 finalColor = u_OutlineColor.rgb * u_OutlineLightness; \r\n    gl_FragColor = vec4(finalColor,0.0); \r\n    gl_FragColor = outputTransform(gl_FragColor);\r\n}';
  ...
  var outline02_default = '// 原来的写法会被我们自己的解析流程处理，而我们的解析是不认内置宏的，导致被删掉，所以改成 if defined 了\r\n#if defined(GL_FRAGMENT_PRECISION_HIGH)\r\nprecision highp float;\r\n#else\r\nprecision mediump float;\r\n#endif\r\n#include "Color.glsl";\r\nvarying vec2 v_Texcoord0;\r\nvarying vec3 v_Normal;\r\nvec4 sampleMainTex(sampler2D tex, vec2 uv)\r\n{\r\n    vec4 mainSampler = texture2D(tex, uv);\r\n#ifdef Gamma_u_AlbedoTexture\r\n    mainSampler = gammaToLinear(mainSampler);\r\n#endif // Gamma_u_MainTex\r\n    return mainSampler;\r\n}\r\nvoid main()\r\n{\r\n    vec4 albedoTextureColor = vec4(1.0);\r\n    \r\n    albedoTextureColor = sampleMainTex(u_AlbedoTexture, v_Texcoord0);\r\n    gl_FragColor = albedoTextureColor;\r\n    gl_FragColor = outputTransform(gl_FragColor);\r\n}';
  ...
  var Shader_MultiplePassOutline = class extends BaseScript {
    ...
    onAwake() {
      ...
      Laya.loader.load("resources/res/threeDimen/skinModel/LayaMonkey/Assets/LayaMonkey/LayaMonkey-LayaMonkey.lm").then((mesh) => {
        var layaMonkey = this.createMeshSprite3D(mesh, null);
        ...
        layaMonkey.getComponent(Laya.MeshRenderer).sharedMaterial = customMaterial;
  ...
  __decorateClass([
    property225(Laya.Sprite3D)
  ], Shader_MultiplePassOutline.prototype, "directionLight", 2);
  Shader_MultiplePassOutline = __decorateClass([
    regClass226("26062f24-2085-4285-a5ab-14930e991ee7", "../src/3D/Shader/Shader_MultiplePassOutline.ts")
  ...
  var _MultiplePassOutlineMaterial = class _MultiplePassOutlineMaterial extends Material6 {
    ...
    constructor() {
      ...
      this.setColorByIndex(_MultiplePassOutlineMaterial.OUTLINECOLOR, new Color24(1, 1, 1, 0));
    }
  };
  ...
  Shader_Simple = __decorateClass([
    regClass227("6a5477d4-4ac4-4f25-bb34-c85456fbe961", "../src/3D/Shader/Shader_Simple.ts")
  ], Shader_Simple);
  ...
  CerberusModelShow = __decorateClass([
    regClass229("9e930e25-774c-4af3-aa86-5a0f36168fa7", "../src/3D/Show/CerberusModelShow.ts")
  ], CerberusModelShow);
  ...
  DamagedHelmetModelShow = __decorateClass([
    regClass230("56ac9a0b-bb60-47e3-aeac-5934275aea57", "../src/3D/Show/DamagedHelmetModelShow.ts")
  ...
  GunDemo = __decorateClass([
    regClass231("f243b4bd-0fe2-416c-a7a9-301c361c4296", "../src/3D/Show/GunDemo.ts")
  ], GunDemo);
  ...
  __decorateClass([
    property231(Laya.Sprite3D)
  ], Sky_Procedural.prototype, "directionLight", 2);
  Sky_Procedural = __decorateClass([
    regClass232("c4a1bcfb-da17-46d6-a7fa-70b3721d13b0", "../src/3D/Sky/Sky_Procedural.ts")
  ], Sky_Procedural);
  ...
  Sky_SkyBox = __decorateClass([
    regClass233("2d0df284-0ddc-495f-ae6e-bd620726ad9e", "../src/3D/Sky/Sky_SkyBox.ts")
  ], Sky_SkyBox);
  ...
  var PixelLineSprite3DDemo = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector371(0, 1.2, 3.5);
      this.camera.transform.rotate(new Vector371(-15, 0, 0), true, false);
      this.sprite3D = this.scene.addChild(new Sprite3D15());
      this.lineSprite3D = this.scene.addChild(new Sprite3D15());
      var sphere = this.createMeshSprite3D(PrimitiveMesh30.createSphere(0.25, 20, 20), null);
      this.sprite3D.addChild(sphere);
      sphere.transform.position = new Vector371(0, 0.75, 2);
      var sphereLineSprite3D = this.lineSprite3D.addChild(new PixelLineSprite3D5(3500));
  ...
  PixelLineSprite3DDemo = __decorateClass([
    regClass234("cc0f6877-b7f3-4e00-b4a7-a681765fca59", "../src/3D/Sprite3D/PixelLineSprite3DDemo.ts")
  ...
  var _Tool3 = class _Tool3 {
    static linearModel(sprite3D, lineSprite3D, color) {
      if (sprite3D.getComponent(Laya.MeshFilter)) {
        ...
        for (var i = 0; i < indices.length; i += 3) {
          ...
          var vertex1 = positions[indices[i + 1]];
          var vertex2 = positions[indices[i + 2]];
          Vector371.transformCoordinate(vertex0, meshSprite3D.transform.worldMatrix, this.transVertex0);
          Vector371.transformCoordinate(vertex1, meshSprite3D.transform.worldMatrix, this.transVertex1);
          Vector371.transformCoordinate(vertex2, meshSprite3D.transform.worldMatrix, this.transVertex2);
          lineSprite3D.addLine(this.transVertex0, this.transVertex1, color, color);
          lineSprite3D.addLine(this.transVertex1, this.transVertex2, color, color);
          lineSprite3D.addLine(this.transVertex2, this.transVertex0, color, color);
        }
    ...
    static DrawBoundingBox(sprite3D, sprite, color) {
      sprite3D.getComponent(Laya.MeshRenderer).bounds.getCorners(_Tool3.corners);
      var rotate = new Vector371(0, 0, 90);
    ...
    static DrawTwelveLines(start, end, rotate, sprite3D) {
      var length = Vector371.distance(start, end);
      var cylinder = new Laya.Sprite3D();
      let mesh = PrimitiveMesh30.createCylinder(4e-3, length, 3);
      let meshfilter = cylinder.addComponent(Laya.MeshFilter);
      let meshrender = cylinder.addComponent(Laya.MeshRenderer);
      meshfilter.sharedMesh = mesh;
      sprite3D.addChild(cylinder);
  ...
  __name(_Tool3, "Tool");
  _Tool3.transVertex0 = new Vector371();
  _Tool3.transVertex1 = new Vector371();
  _Tool3.transVertex2 = new Vector371();
  _Tool3.corners = [];
  var Tool3 = _Tool3;
  ...
  var ScreenShot = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector372(0, 2, 3);
    ...
    onAddClick() {
      ...
      renderTargetCamera.transform.position = new Vector372(0, 2, 3);
  ...
  ScreenShot = __decorateClass([
    regClass235("2d929ea3-aad3-4da4-afb3-6ccc73bd41f8", "../src/3D/Sprite3D/ScreenShot.ts")
  ], ScreenShot);
  ...
  var SkinnedMeshSprite3DDemo = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector373(0, 1.6, 2);
      this.camera.transform.rotate(new Vector373(-15, 0, 0), true, false);
      Laya.loader.load("resources/res/threeDimen/skinModel/dude/dude.lh").then((res) => {
        var dude = this.scene.addChild(res.create());
        var scale = new Vector373(0.5, 0.5, 0.5);
        dude.transform.localScale = scale;
        dude.transform.rotate(new Vector373(0, 3.14, 0));
      });
    }
  };
  ...
  SkinnedMeshSprite3DDemo = __decorateClass([
    regClass236("2696a176-66f9-4aac-81f7-dd3a6d9b0803", "../src/3D/Sprite3D/SkinnedMeshSprite3DDemo.ts")
  ...
  var Sprite3DClone = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector374(0, 0.5, 1);
  ...
  Sprite3DClone = __decorateClass([
    regClass237("6492c680-4d83-4ad7-8e22-558f7502a378", "../src/3D/Sprite3D/Sprite3DClone.ts")
  ], Sprite3DClone);
  ...
  var Sprite3DParent = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector375(0, 0.75, 1);
      this.camera.transform.rotate(new Vector375(-30, 0, 0), true, false);
      ...
      Laya.loader.load(resource).then((res) => {
        ...
        this.layaMonkeySon.transform.localPosition = new Vector375(0.2, 0, 0);
        var scale = new Vector375(0.5, 0.5, 0.5);
    ...
    loadUI() {
      Laya.loader.load(["resources/image/img_btn_bg.png"], Handler22.create(this, () => {
        this.changeActionButton = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "移动父级猴子"));
        ...
        this.changeActionButton.on(Event53.CLICK, this, this.stypeFun0);
        this.changeActionButton1 = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "放大父级猴子"));
        ...
        this.changeActionButton1.on(Event53.CLICK, this, this.stypeFun1);
        this.changeActionButton2 = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "旋转父级猴子"));
        ...
        this.changeActionButton2.on(Event53.CLICK, this, this.stypeFun2);
        this.changeActionButton3 = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "移动子级猴子"));
        ...
        this.changeActionButton3.on(Event53.CLICK, this, this.stypeFun3);
        this.changeActionButton4 = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "放大子级猴子"));
        ...
        this.changeActionButton4.on(Event53.CLICK, this, this.stypeFun4);
        this.changeActionButton5 = this.owner.addChild(new Button10("resources/image/img_btn_bg.png", "旋转子级猴子"));
        ...
        this.changeActionButton5.on(Event53.CLICK, this, this.stypeFun5);
      }));
    }
    stypeFun0() {
      this.layaMonkeyParent.transform.translate(new Vector375(-0.1, 0, 0));
    }
    stypeFun1() {
      var scale = new Vector375(1.2, 1.2, 1.2);
      this.layaMonkeyParent.transform.localScale = scale;
    }
    stypeFun2() {
      this.layaMonkeyParent.transform.rotate(new Vector375(-15, 0, 0), true, false);
    }
    stypeFun3() {
      this.layaMonkeySon.transform.translate(new Vector375(-0.1, 0, 0));
    }
    stypeFun4() {
      var scale = new Vector375(1, 1, 1);
      this.layaMonkeySon.transform.localScale = scale;
    }
    stypeFun5() {
      this.layaMonkeySon.transform.rotate(new Vector375(-15, 0, 0), true, false);
    }
  };
  ...
  Sprite3DParent = __decorateClass([
    regClass238("8a84c63f-4b5c-4951-a103-ddc9725dfb18", "../src/3D/Sprite3D/Sprite3DParent.ts")
  ], Sprite3DParent);
  ...
  var TransformDemo = class extends BaseScript {
    constructor() {
      super();
      this._position = new Vector376(0, 0, 0);
      this._position1 = new Vector376(0, 0, 0);
      this._rotate = new Vector376(0, 1, 0);
      this._rotate1 = new Vector376(0, 0, 0);
      this._scale = new Vector376();
      this.scaleDelta = 0;
      this.scaleValue = 0;
    }
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector376(0, 1, 1);
      this.camera.transform.rotate(new Vector376(-30, 0, 0), true, false);
    ...
    onComplete(res) {
      ...
      this.layaMonkey_clone1 = Sprite3D16.instantiate(staticLayaMonkey, this.scene, false, this._position1);
      this.layaMonkey_clone2 = Sprite3D16.instantiate(staticLayaMonkey, this.scene, false, this._position1);
      this.layaMonkey_clone3 = Sprite3D16.instantiate(staticLayaMonkey, this.scene, false, this._position1);
  ...
  TransformDemo = __decorateClass([
    regClass239("aaa3a9c3-1868-422a-bd97-2d89afac88e3", "../src/3D/Sprite3D/TransformDemo.ts")
  ], TransformDemo);
  ...
  __decorateClass([
    property239(Laya.Sprite3D)
  ], RemotePackageLoad.prototype, "directionLight", 2);
  RemotePackageLoad = __decorateClass([
    regClass240("317590ee-de73-4836-8462-1d18023a7f53", "../src/3D/SubPackageLoad/RemotePackageLoad.ts")
  ], RemotePackageLoad);
  ...
  SubpackageLoad = __decorateClass([
    regClass241("0face2b3-400d-4432-816f-72f852478f01", "../src/3D/SubPackageLoad/SubpackageLoad.ts")
  ], SubpackageLoad);
  ...
  var GPUCompression_ASTC = class extends BaseScript {
    ...
    onAwake() {
      ...
      let meshSprite = this.createMeshSprite3D(PrimitiveMesh31.createBox(0.5, 0.5, 0.5), null);
      meshSprite.transform.position = new Vector377(0, 1, 2.5);
      ...
      this.text = new Laya.Label();
      if (!Browser6.onAndroid && !Browser6.onIOS && !Browser6.onOpenHarmonyOS) {
  ...
  GPUCompression_ASTC = __decorateClass([
    regClass242("66473e24-1d08-4144-bc10-cbf7b21be996", "../src/3D/Texture/GPUCompression_ASTC.ts")
  ], GPUCompression_ASTC);
  ...
  var GPUCompression_ETC2 = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector378(0, 1.5, 4);
      this.camera.transform.rotate(new Vector378(-15, 0, 0), true, false);
      let meshSprite = this.createMeshSprite3D(PrimitiveMesh32.createBox(0.5, 0.5, 0.5), null);
      meshSprite.transform.position = new Vector378(0, 1, 2.5);
      meshSprite.transform.rotate(new Laya.Vector3(0, 0, 0), false, false);
      this.mat = new UnlitMaterial6();
      this.scene.addChild(meshSprite);
      meshSprite.getComponent(MeshRenderer10).sharedMaterial = this.mat;
      this.text = new Laya.Label();
      if (!Browser7.onAndroid && !Browser7.onOpenHarmonyOS) {
  ...
  GPUCompression_ETC2 = __decorateClass([
    regClass243("b4e4996e-ddc4-4a2f-ac32-6dfc7061d87d", "../src/3D/Texture/GPUCompression_ETC2.ts")
  ], GPUCompression_ETC2);
  ...
  var HalfFloatTexture = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector379(0, 1.5, 4);
      this.camera.transform.rotate(new Vector379(-15, 0, 0), true, false);
      this.sprite3D = this.scene.addChild(new Sprite3D17());
      var box = this.createMeshSprite3D(PrimitiveMesh33.createBox(0.5, 0.5, 0.5), null);
      this.sprite3D.addChild(box);
      box.transform.position = new Vector379(0, 1, 2.5);
  ...
  HalfFloatTexture = __decorateClass([
    regClass244("92353217-1135-41b9-8666-3566ab52481d", "../src/3D/Texture/HalfFloatTexture.ts")
  ], HalfFloatTexture);
  ...
  var TextureDemo = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector380(0, 1.5, 4);
      this.camera.transform.rotate(new Vector380(-15, 0, 0), true, false);
      this.sprite3D = this.scene.addChild(new Sprite3D18());
      var box = this.createMeshSprite3D(Laya.PrimitiveMesh.createBox(0.5, 0.5, 0.5), null);
      this.sprite3D.addChild(box);
      box.transform.position = new Laya.Vector3(0, 1, 2.5);
      box.transform.rotate(new Laya.Vector3(0, 0, 0), false, false);
      var mater = new Laya.BlinnPhongMaterial();
      box.getComponent(Laya.MeshRenderer).sharedMaterial = mater;
  ...
  TextureDemo = __decorateClass([
    regClass245("773fb133-301c-42d7-9497-2c837fae0d70", "../src/3D/Texture/TextureDemo.ts")
  ], TextureDemo);
  ...
  var TextureGPUCompression = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector381(0, 2, 5);
      this.camera.transform.rotate(new Vector381(-15, 0, 0), true, false);
      Scene3D3.load("resources/res/CompressTexture/scene.ls", Handler23.create(this, (scene) => {
        this.scene.addChild(scene);
      }));
    }
  };
  ...
  TextureGPUCompression = __decorateClass([
    regClass246("9fcfabed-2691-4ea7-94a5-1f271b7976c8", "../src/3D/Texture/TextureGPUCompression.ts")
  ...
  var TrailRender = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.camera.transform.position = new Vector382(0, 4, 5);
      this.camera.transform.rotate(new Vector382(-45, 0, 0), true, false);
      this.camera.clearFlag = CameraClearFlags12.SolidColor;
      this.directionLight = this.scene.getChildByName("Direction Light");
      this.directionLightCom = this.directionLight.getComponent(Laya.DirectionLightCom);
      this.directionLightCom.color = new Color26(1, 1, 1, 1);
      this.directionLight.transform.rotate(new Vector382(-Math.PI / 3, 0, 0));
      Laya.loader.load("resources/res/threeDimen/staticModel/grid/plane.lh").then((res) => {
        this.scene.addChild(res.create());
      });
  ...
  TrailRender = __decorateClass([
    regClass247("0af430ec-19bc-47db-b124-a00c2705b152", "../src/3D/Trail/TrailRender.ts")
  ], TrailRender);
  ...
  WebXRStart = __decorateClass([
    regClass248("05c6355c-8704-4892-b83d-b8dc57902187", "../src/3D/WebXR/WebXRStart.ts")
  ], WebXRStart);
  ...
  var bluePrintDemo = class extends BaseScript {
    constructor() {
      super(...arguments);
      this.monkeyPath = "resources/res/threeDimen/skinModel/LayaMonkey/LayaMonkey.lh";
      this.testBPMatPath = "resources/res/bluePrint/bpMat.lmat";
      this.testBPShaderPath = "resources/res/bluePrint/testBP.bps";
      this.testBPShaderName = "testBP";
    }
    //组件被激活后执行，此时所有节点和组件均已创建完毕，此方法只执行一次
    onAwake() {
      super.base(this.camera);
    ...
    onEnable() {
      ...
      Laya.loader.load([this.monkeyPath, this.testBPMatPath]).then(() => {
        if (this.monkey)
          return;
        this.monkey = Laya.loader.getRes(this.monkeyPath).create();
    ...
    onBtnClick() {
      let mat = Laya.loader.getRes(this.testBPMatPath);
      mat.setShaderData("metaParam", Laya.ShaderDataType.Float, 1);
    ...
    onBtnShaderClick() {
      Laya.loader.load(this.testBPShaderPath).then(() => {
        let meshrender = this.monkey.getChildAt(0).getChildAt(1).getComponent(Laya.SkinnedMeshRenderer);
  ...
  var entry = class extends Laya.Script {
    ...
    getExtAndCapable(index, isExt = true) {
      let extStringMap = [
      ...
      let capStringMap = [
        ...
        //Rendertexture Float16
        "RenderTextureFormat_R32G32B32A32",
        // rendertexture float32
        ...
        "Shader_TextureLod",
        //Texture lod sampler
        "COMPRESS_TEXTURE_S3TC",
        //compress Texture dds
        "COMPRESS_TEXTURE_S3TC_SRGB",
        //Compress Texture dds srgb
        "COMPRESS_TEXTURE_PVRTC",
        //Compress Texture PVR
        "COMPRESS_TEXTURE_ETC1",
        //Compress Texture ktx
        "COMPRESS_TEXTURE_ETC",
        //Compress Texture ktx
        "COMPRESS_TEXTURE_ASTC",
        //Compress Texture astc
        "Texture_SRGB",
        //Textrue srgb   
        "MSAA",
        //MSAA
    ...
    logAllExtMap() {
      if (!Laya.LayaEnv.isConch) {
        ...
        let exmap = Laya.LayaGL.renderEngine._supportCapatable._extensionMap;
        let capmap = Laya.LayaGL.renderEngine._supportCapatable._capabilityMap;
    ...
    Btonselect() {
      ...
      this.Small_cb.getChildAt(0).label = Scenename;
    ...
    Bigonselect(index) {
      ...
      this.Big_cb.getChildAt(0).label = this.Demo_2D_Name[this.index_2D];
      this.index_index_2D = 0;
      ...
      this.Small_cb.getChildAt(0).label = this.Demo_2D[this.index_2D][0].name;
      this.destoryLastScene();
    ...
    Smallonselect(index) {
      ...
      this.Small_cb.defaultLabel = this.Demo_2D[this.index_2D][this.index_index_2D].name;
      this.Small_cb.getChildAt(0).label = this.Demo_2D[this.index_2D][this.index_index_2D].name;
      let SmallScene2 = this.Demo_2D[this.index_2D][this.index_index_2D];
      let Scenename = this.Demo_2D[this.index_2D][this.index_index_2D].name;
      this.destoryLastScene();
      this.openDemoScene(this.resPath, SmallScene2);
  ...
  entry = __decorateClass([
    regClass250("ca351474-2c38-4638-b3fc-6c9899b3d731", "../src/Entry.ts")
  ], entry);

  // src/Entry_WebGPU.ts
  var { regClass: regClass251, property: property250 } = Laya;
  var entry2 = class extends Laya.Script {
    constructor() {
      super(...arguments);
      this.is2D = false;
      this.is3D = false;
  ...
  __decorateClass([
    property250(Boolean)
  ], entry2.prototype, "is2D", 2);
  __decorateClass([
    property250(Boolean)
  ], entry2.prototype, "is3D", 2);
  entry2 = __decorateClass([
    regClass251("f8c91f84-e924-4d9c-b8b8-5a7bace657ae", "../src/Entry_WebGPU.ts")
  ], entry2);
  ...
  Main = __decorateClass([
    regClass252("ad3cf108-21a0-4a90-9e86-6a401327d722", "../src/Main.ts")
  ], Main);
})();
