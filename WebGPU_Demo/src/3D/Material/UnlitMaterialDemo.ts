...
export class UnlitMaterialDemo extends BaseScript {
	...
	onAwake(): void {
		...
		var earth1: Laya.Sprite3D = new Laya.Sprite3D();
		let earth1Meshfilter: Laya.MeshFilter = earth1.addComponent(Laya.MeshFilter);
		let earth1Meshrender: Laya.MeshRenderer = earth1.addComponent(Laya.MeshRenderer);
		earth1Meshfilter.sharedMesh = sphereMesh;
		this.scene.addChild(earth1);
		earth1.transform.position = new Vector3(-0.6, 0, 0);
		var earth2: Laya.Sprite3D = new Laya.Sprite3D();
		let earth2Meshfilter: Laya.MeshFilter = earth2.addComponent(Laya.MeshFilter);
		let earth2Meshrender: Laya.MeshRenderer = earth2.addComponent(Laya.MeshRenderer);
