...
export class EffectMaterialDemo extends BaseScript {
	...
	onAwake(): void {
		...
		var earth: Laya.Sprite3D = new Laya.Sprite3D();
		let earthMeshfilter: Laya.MeshFilter = earth.addComponent(Laya.MeshFilter);
		let earthMeshrender: Laya.MeshRenderer = earth.addComponent(Laya.MeshRenderer);
		let sphereMesh: Laya.Mesh = PrimitiveMesh.createSphere();
