...
export class GCASystemTest {
    ...
    constructor() {
        Laya.init(0, 0).then(() => {
            ...
            var camera: Laya.Camera = (<Laya.Camera>scene.addChild(new Laya.Camera(0, 0.1, 500)));
            camera.transform.translate(new Laya.Vector3(-49.22597611084587, 32.18178779371752, 32.400060133440455));
            camera.transform.rotation = new Laya.Quaternion(-0.17967885879238119, -0.7626494012869607, -0.2389016021843756, 0.5735916865623546)
            camera.addComponent(CameraMoveScript);
            camera.clearColor = new Laya.Color(0.0, 0.0, 0.0, 1.0);
            ...
            let sprite = scene.addChild(new Laya.Sprite3D());
