...
import { GCA_BatchType, GCA_Config } from "./GCA_Config";
...
export class GCA_InstanceRenderElementCollect {
    ...
    private _clearBufferShader: Laya.ComputeShader;
    ...
    clearBufferDeviceBuffer: Laya.WebGPUDeviceBuffer;
    clearBufferUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);
    ...
    aabbDeviceBuffer: Laya.WebGPUDeviceBuffer;
    aabbUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);
    ...
    instanceIndexDeviceBuffer: Laya.WebGPUDeviceBuffer;
    instanceIndexUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);
    ...
    indirectDeviceBuffer: Laya.WebGPUDeviceBuffer;
    indirectUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);

    //WorldMatrixBuffer --渲染使用
    // 分给OneBatch来填写
    wholeWorldMatrixBuffer: Float32Array;
    worldMatrixDeviceBuffer: Laya.WebGPUDeviceBuffer;
    worldMatrixUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);

    //CustomBuffer --渲染使用
    // 分给OneBatch来填写
    wholeCustomBuffer: Float32Array;
    customDeviceBuffer: Laya.WebGPUDeviceBuffer;
    customUpdateRange: Laya.Vector2 = new Laya.Vector2(LargeData, -LargeData);

    //=========== GPUBuffer 属性 End=============

    //===========Compute Cull 属性 start==========
    private _shaderList: Laya.ShaderData[] = [];
    private _deviceBuffer: Laya.ShaderData;

    private _computeShader: Laya.ComputeShader;

    private _shaderDefine: Laya.IDefineDatas;

    private _dispartchParams: Laya.Vector3 = new Laya.Vector3();
    private _clearBufferDispartchParams: Laya.Vector3 = new Laya.Vector3();

    private _cullShaderData: Laya.ShaderData;
    //=============compute Cull 属性 End =========
    ...
    constructor(blockCount: GCA_BatchType) {
        ...
        this._dispartchParams = new Laya.Vector3((GCA_Config.MaxBatchComputeCount / GCA_Config.CULLING_WORKGROUP_SIZE) | 0, 1, 1);
        this._clearBufferDispartchParams = new Laya.Vector3(this.maxBlockCount, 1, 1);
    ...
    setCullShaderData(data: Laya.ShaderData) {
    ...
    initComputeCommand() {
        ...
        let shaderData1 = this._deviceBuffer = Laya.LayaGL.renderDeviceFactory.createShaderData();
        {
            shaderData1.setDeviceBuffer(Laya.Shader3D.propertyNameToID("aabbs"), this.aabbDeviceBuffer);
            shaderData1.setDeviceBuffer(Laya.Shader3D.propertyNameToID("culled"), this.instanceIndexDeviceBuffer);
            shaderData1.setDeviceBuffer(Laya.Shader3D.propertyNameToID("indirectArgs"), this.indirectDeviceBuffer);
            shaderData1.setDeviceBuffer(Laya.Shader3D.propertyNameToID("clearBuffer"), this.clearBufferDeviceBuffer);
        }
    ...
    insertComputeCommand(compute: Laya.ComputeCommandBuffer) {
    ...
    private _createBufferAndData() {
        ...
        this.clearBufferDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST | Laya.EDeviceBufferUsage.COPY_SRC) as Laya.WebGPUDeviceBuffer;
        this.clearBufferDeviceBuffer.setDataLength(this.maxBlockCount * 4);

        //aabb
        this.aabbDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST | Laya.EDeviceBufferUsage.COPY_SRC) as Laya.WebGPUDeviceBuffer;
        ...
        //instanceIndex
        this.instanceIndexDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST | Laya.EDeviceBufferUsage.COPY_SRC) as Laya.WebGPUDeviceBuffer;
        ...
        this.indirectDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.INDIRECT | Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST) as Laya.WebGPUDeviceBuffer;
        ...
        //worldMatrix
        this.worldMatrixDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST) as Laya.WebGPUDeviceBuffer;
        ...
        //customBuffer
        this.customDeviceBuffer = Laya.LayaGL.renderDeviceFactory.createDeviceBuffer(Laya.EDeviceBufferUsage.STORAGE | Laya.EDeviceBufferUsage.COPY_DST | Laya.EDeviceBufferUsage.COPY_SRC) as Laya.WebGPUDeviceBuffer;
