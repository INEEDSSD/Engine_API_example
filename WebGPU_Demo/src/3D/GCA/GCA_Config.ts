...
export class GCA_Config {
    ...
    static MaxBatchCountLarge: number = 384;
    static CULLING_WORKGROUP_SIZE = 64;
    static MaxBatchComputeCount: number = 384;
    ...
    static init() {
        GCA_OneBatchInfo.GCA_StorageBuffer = Laya.Shader3D.getDefineByName("GCA_StorageBuffer");
    }
}
