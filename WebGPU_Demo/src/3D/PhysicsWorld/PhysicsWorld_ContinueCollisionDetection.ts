...
export class PhysicsWorld_ContinueCollisionDetection extends BaseScript {
	...
	onComplete(res: any[]): void {
		//平面
		var plane = this.createMeshSprite3D(PrimitiveMesh.createPlane(20, 20, 10, 10), null);
	...
	addSphere(): void {
		...
		(sphere.getComponent(Laya.MeshRenderer).sharedMaterial as BlinnPhongMaterial).albedoTexture = Laya.Loader.getRes("resources/res/threeDimen/Physics/plywood.jpg") as Texture2D;
