...
export class PhysicsWorld_Character extends BaseScript {
    ...
    public addBox(): void {
        ...
        var box: Laya.Sprite3D = this.createMeshSprite3D(Laya.PrimitiveMesh.createBox(sX, sY, sZ), null);
    ...
    public addCapsule(): void {
        ...
        var capsule: Laya.Sprite3D = this.createMeshSprite3D(Laya.PrimitiveMesh.createCapsule(raidius, height), null);
