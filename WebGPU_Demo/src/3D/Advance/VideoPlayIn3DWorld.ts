...
export class VideoPlayIn3DWorld extends BaseScript {
    ...
    onAwake(): void {
        ...
        mirrorFloor.mirrorPlane = this.scene.getChildByName("reflectionPlan") as Laya.Sprite3D;

        //增加视频
        this.videoPlane = this.scene.getChildByName("moveclip") as Laya.Sprite3D;
...
export class ChinarMirrorPlane extends Script {
    ...
    public _mirrorPlane: Laya.Sprite3D;
    ...
    set mirrorPlane(value: Laya.Sprite3D) {
        this._mirrorPlane = value;
        var material: UnlitMaterial = new UnlitMaterial();
        let value1: Laya.Sprite3D = value as Laya.Sprite3D;
