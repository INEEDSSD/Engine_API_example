...
export class SeparableSSS_RenderDemo extends BaseScript {
    ...
    blinnphongCharacter: Laya.Sprite3D;
    SSSSSCharacter: Laya.Sprite3D;
    characterBlinnphongMaterial: BlinnPhongMaterial;
    pbrCharacter: Laya.Sprite3D;
    ...
    onPreLoadFinish(res: any) {
        ...
        //增加节点
        this.SSSSSCharacter = <Laya.Sprite3D>this.blinnphongCharacter.clone();
