...
export class BlurGlass extends BaseScript {
	...
	onAwake(): void {
		...
		var glass01: Laya.Sprite3D = scene.getChildByName("glass01") as Laya.Sprite3D;
		var glass02: Laya.Sprite3D = scene.getChildByName("glass02") as Laya.Sprite3D;
		//在这里切换了材质
	...
	createCommandBuffer(camera: Laya.Camera) {
		...
		var shaderValue: Laya.ShaderData = Laya.LayaGL.renderDeviceFactory.createShaderData(null);
