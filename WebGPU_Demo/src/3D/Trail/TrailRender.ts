...
export class TrailRender extends BaseScript {
	...
	private directionLightCom: Laya.DirectionLightCom;
	...
	onAwake(): void {
		...
		//设置平行光颜色
		this.directionLight = (this.scene.getChildByName("Direction Light") as Laya.Sprite3D);
		this.directionLightCom = this.directionLight.getComponent(Laya.DirectionLightCom);
		this.directionLightCom.color = new Color(1, 1, 1, 1);
