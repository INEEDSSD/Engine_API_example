...
export class Sound_SimpleDemo extends BaseScript {
	...
	private _soundIndex: number = 0;
	private _musicIndex: number = 0;
	...
	private onPlayMusic(e: Event = null): void {
		if (this._musicIndex % 2 == 0) {
			...
			SoundManager.playMusic("resources/res/sounds/bgm1.mp3", 1, new Handler(this, this.onComplete));
		}
		this._musicIndex++;
	}
	...
	private onPlaySound(e: Event = null): void {
		if (this._soundIndex % 2 == 0) {
			...
			SoundManager.playSound("resources/res/sounds/destroy.wav", 1, new Handler(this, this.onComplete));
		}
		this._soundIndex++;
	}
