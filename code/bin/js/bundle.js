...
(() => {
  ...
  var Physics_Bridge = class extends BaseScript {
    ...
    onDestroy() {
      this.box2D.offAll(Event21.CLICK);
      this.box2D.removeChild(this.label);
    }
  };
  __name(Physics_Bridge, "Physics_Bridge");
  Physics_Bridge = __decorateClass([
    regClass40("47c09d32-9526-42e6-8283-e1c8f965b163", "../src/2D/Physics/Physics_Bridge.ts")
  ], Physics_Bridge);
  ...
  var Physics_CollisionEvent = class extends BaseScript {
    ...
    createSensor() {
      ...
      ground.on(Event22.TRIGGER_ENTER, this, this.onTriggerEnter);
      ground.on(Event22.TRIGGER_EXIT, this, this.onTriggerExit);
  ...
  Physics_CollisionEvent = __decorateClass([
    regClass41("1d0e4f07-4a46-4ccf-83f6-07d08e36a763", "../src/2D/Physics/Physics_CollisionEvent.ts")
  ...
  var Physics_CollisionFiltering = class extends BaseScript {
    ...
    createBox(posx, posy, width, height, ratio) {
      let box = new Sprite23();
      box.on(Event23.MOUSE_DOWN, this, this.mouseDown);
    ...
    createTriangle(posx, posy, side, ratio) {
      let triangle = new Sprite23();
      triangle.on(Event23.MOUSE_DOWN, this, this.mouseDown);
    ...
    createCircle(posx, posy, radius, ratio) {
      let circle = new Sprite23();
      circle.on(Event23.MOUSE_DOWN, this, this.mouseDown);
    ...
    mouseDown(e) {
      ...
      this.box2D.on(Event23.MOUSE_UP, this, this.destoryJoint);
      this.box2D.on(Event23.MOUSE_OUT, this, this.destoryJoint);
    }
    mouseMove(e) {
    ...
    mouseUp() {
      this.box2D.off(Event23.MOUSE_MOVE, this, this.mouseMove);
      this.box2D.off(Event23.MOUSE_UP, this, this.mouseUp);
      this.box2D.off(Event23.MOUSE_OUT, this, this.mouseUp);
    ...
    destoryJoint() {
      this.box2D.off(Event23.MOUSE_UP, this, this.destoryJoint);
      this.box2D.off(Event23.MOUSE_OUT, this, this.destoryJoint);
  ...
  Physics_CollisionFiltering = __decorateClass([
    regClass42("699cf22f-9b38-440d-9278-5bf1a82cbc7a", "../src/2D/Physics/Physics_CollisionFiltering.ts")
  ...
  var Physics_Strandbeests = class extends BaseScript {
    ...
    Construct() {
      ...
      let chassis = this.chassis = new Sprite24();
      ...
      let wheel = this.wheel = new Sprite24();
    ...
    dispose() {
      Laya.stage.offAll(Event24.CLICK);
      Laya.stage.offAll(Event24.DOUBLE_CLICK);
      this.box2D.removeChild(this.label);
    }
  };
  __name(Physics_Strandbeests, "Physics_Strandbeests");
  Physics_Strandbeests = __decorateClass([
    regClass43("6b3e7edf-f04c-4d8b-bb3a-6e08d193d2cb", "../src/2D/Physics/Physics_Strandbeests.ts")
  ...
  var Physics_Tumbler = class extends BaseScript {
    ...
    eventListener() {
      ...
      label.fontSize = 16;
      label.color = "#e69999";
      Laya.stage.on(Event25.DOUBLE_CLICK, this, this.handleMouse);
      Laya.timer.frameLoop(1, this, this.addMiniBox);
    }
    handleMouse() {
    ...
    onDestroy() {
      Laya.stage.offAll(Event25.DOUBLE_CLICK);
      this.box2D.removeChild(this.label);
    }
  };
  __name(Physics_Tumbler, "Physics_Tumbler");
  Physics_Tumbler = __decorateClass([
    regClass44("f1ab357a-3d29-44fd-b4c3-0da0cc19536c", "../src/2D/Physics/Physics_Tumbler.ts")
  ], Physics_Tumbler);
  ...
  var PIXI_Example_1 = class extends BaseScript {
    ...
    onAwake() {
      ...
      this.createText();
      this.start();
      this.box2D.on(Event26.RESIZE, this, this.resize);
    }
    start() {
      for (var i = 0; i < this.starCount; i++) {
        var tempBall = new Sprite26();
  ...
  PIXI_Example_1 = __decorateClass([
    regClass45("92f9f6d8-be63-4ca5-86bb-2ed1b5be63c7", "../src/2D/PIXI/PIXI_Example_1.ts")
  ], PIXI_Example_1);
  ...
  PIXI_Example_2 = __decorateClass([
    regClass46("60f16052-b54c-4618-87b4-8bc1dbfb2c0f", "../src/2D/PIXI/PIXI_Example_2.ts")
  ], PIXI_Example_2);
  ...
  var PIXI_Example_3 = class extends BaseScript {
    ...
    createCanvases() {
      var graphicsCanvas = new Sprite28();
      this.box2D.addChild(graphicsCanvas);
      var liveGraphicsCanvas = new Sprite28();
  ...
  PIXI_Example_3 = __decorateClass([
    regClass47("db6aa75c-0bcd-4553-96a2-6f1c3f6142f3", "../src/2D/PIXI/PIXI_Example_3.ts")
  ], PIXI_Example_3);
  ...
  PIXI_Example_4 = __decorateClass([
    regClass48("9c1ce71b-0f09-4fbd-bdaa-1259cadc79c6", "../src/2D/PIXI/PIXI_Example_4.ts")
  ], PIXI_Example_4);
  var _Laser = class _Laser extends Sprite29 {
  };
  __name(_Laser, "Laser");
  var Laser = _Laser;
  ...
  Text_AutoSize = __decorateClass([
    regClass69("7637aa31-dad9-415a-bd87-059be135c04f", "../src/2D/Text/Text_AutoSize.ts")
  ], Text_AutoSize);
  ...
  Text_BitmapFont = __decorateClass([
    regClass70("f4e2bacf-0e7b-4cac-9278-13ce67fd9752", "../src/2D/Text/Text_BitmapFont.ts")
  ], Text_BitmapFont);
  ...
  Text_ComplexStyle = __decorateClass([
    regClass71("07534d14-3399-4525-9452-5ea65e8ab848", "../src/2D/Text/Text_ComplexStyle.ts")
  ], Text_ComplexStyle);
  ...
  Text_Editable = __decorateClass([
    regClass72("377ed9c2-39f1-4be3-af65-29f085445173", "../src/2D/Text/Text_Editable.ts")
  ], Text_Editable);
  ...
  Text_HTML = __decorateClass([
    regClass73("69205946-36a4-446a-a53a-337a95d28135", "../src/2D/Text/Text_HTML.ts")
  ], Text_HTML);
  ...
  Text_InputMultiline = __decorateClass([
    regClass74("41608eb0-8f61-40e4-bbb9-da03a8b26e24", "../src/2D/Text/Text_InputMultiline.ts")
  ], Text_InputMultiline);
  ...
  Text_InputSingleline = __decorateClass([
    regClass75("180d8844-d5a7-46e6-8d9b-0f882835324a", "../src/2D/Text/Text_InputSingleline.ts")
  ...
  Text_MaxChars = __decorateClass([
    regClass76("5fc3f7f8-2fca-4d92-ad6b-d3721b169668", "../src/2D/Text/Text_MaxChars.ts")
  ], Text_MaxChars);
  ...
  Text_Overflow = __decorateClass([
    regClass77("20ea3e4f-cf7b-49f1-b427-189400071843", "../src/2D/Text/Text_Overflow.ts")
  ], Text_Overflow);
  ...
  Text_Restrict = __decorateClass([
    regClass78("39106029-9ea6-4607-942f-68d6e10e4e5c", "../src/2D/Text/Text_Restrict.ts")
  ], Text_Restrict);
  ...
  Text_Scroll = __decorateClass([
    regClass79("64bf6e22-81b3-42c1-a25c-646966e07a92", "../src/2D/Text/Text_Scroll.ts")
  ], Text_Scroll);
  ...
  Text_UBB = __decorateClass([
    regClass80("cde6d5b6-0518-414c-a63f-93d65985ead2", "../src/2D/Text/Text_UBB.ts")
  ], Text_UBB);
  ...
  Text_Underline = __decorateClass([
    regClass81("63c38139-0fef-4bc6-b483-32a2c735aa0d", "../src/2D/Text/Text_Underline.ts")
  ], Text_Underline);
  ...
  BlurGlass = __decorateClass([
    regClass113("6a7bc5b7-ac78-40d1-975a-19b7d20e0e7b", "../src/3D/Advance/BlurryGlass.ts")
  ], BlurGlass);
  ...
  CameraDepthModeTextureDemo = __decorateClass([
    regClass114("d6fc9519-a7a7-48d7-8431-50af8012c384", "../src/3D/Advance/CameraDepthModeTextureDemo.ts")
  ...
  CameraInteraction = __decorateClass([
    regClass115("7a2191ac-590d-4a34-aa9f-7714eead7c62", "../src/3D/Advance/CameraInteraction.ts")
  ], CameraInteraction);
  ...
  CommandBuffer_DrawCustomInstance = __decorateClass([
    regClass116("309fd40c-2253-4850-b066-7c34fad9be09", "../src/3D/Advance/CommandBuffer_DrawCustomInstance.ts")
  ...
  CommandBuffer_Outline = __decorateClass([
    regClass117("c7b9e97b-dab7-4d49-9974-6722b5ba39ee", "../src/3D/Advance/CommandBuffer_Outline.ts")
...
\r
  ...
  GrassDemo = __decorateClass([
    regClass118("d5231def-e006-48c3-9255-c53a9d98e2db", "../src/3D/Advance/GrassDemo.ts")
  ], GrassDemo);
  ...
  __decorateClass([
    property119(Laya.DirectionLightCom)
  ], Laya3DCombineHtml.prototype, "directionLight", 2);
  Laya3DCombineHtml = __decorateClass([
    regClass119("f0a5c24b-f6a4-4272-a7a2-ad8ea4dd8cdf", "../src/3D/Advance/Laya3DCombineHtml.ts")
  ], Laya3DCombineHtml);
  ...
  ReflectionProbe = __decorateClass([
    regClass120("9e38f354-1eda-4e06-8ff9-e6cc6f2e7b02", "../src/3D/Advance/ReflectionProbe.ts")
  ], ReflectionProbe);
  ...
  Scene2DPlayer3D = __decorateClass([
    regClass121("b1a8ad5f-4f94-4a9e-a459-06d520ac09f3", "../src/3D/Advance/Scene2DPlayer3D.ts")
  ], Scene2DPlayer3D);
  ...
  Secne3DPlayer2D = __decorateClass([
    regClass122("4980a528-7cac-4b04-8b52-e276f98d4dc2", "../src/3D/Advance/Secne3DPlayer2D.ts")
  ], Secne3DPlayer2D);
...
`;
  ...
  SeparableSSS_RenderDemo = __decorateClass([
    regClass123("3c9bc866-29a5-4bec-a511-58ef2b18c156", "../src/3D/Advance/SeparableSSS_RenderDemo.ts")
  ...
  showFont = __decorateClass([
    regClass124("44e834ee-b3dc-4126-82dd-23c7705c857f", "../src/3D/Advance/showFont.ts")
  ], showFont);
  ...
  UI3D = __decorateClass([
    regClass125("cb83f637-7a02-4212-b171-61f071ef5675", "../src/3D/Advance/UI3D.ts")
  ], UI3D);
  ...
  VideoPlayIn3DWorld = __decorateClass([
    regClass126("6af74c14-698e-40a9-906d-f667109ae8f0", "../src/3D/Advance/VideoPlayIn3DWorld.ts")
  ], VideoPlayIn3DWorld);
  ...
  var BoneLinkSprite3D = class extends BaseScript {
    ...
    loadUI() {
      Laya.loader.load(["resources/image/img_btn_bg.png"], Handler18.create(this, () => {
  ...
  var SkeletonMask = class extends BaseScript {
    ...
    onAwake() {
      super.base(this.camera);
      this.loadFont();
      Scene3D.load("resources/res/threeDimen/LayaScene_MaskModelTest/Conventional/MaskModelTest.ls", Handler19.create(this, (scene) => {
  ...
  Particle_BurningGround = __decorateClass([
    regClass167("5eea8353-e9cb-4b19-b502-9476e37c9539", "../src/3D/Particle/Particle_BurningGround.ts")
  ...
  Particle_EternalLight = __decorateClass([
    regClass168("d541fe0e-8ad3-4fe5-ad82-88c95454d9b7", "../src/3D/Particle/Particle_EternalLight.ts")
  ...
  DynamicBatchTest = __decorateClass([
    regClass169("05b00a16-ebe7-459a-81d3-ba04127e4f17", "../src/3D/PerformanceTest/DynamicBatchTest.ts")
  ], DynamicBatchTest);
  ...
  StaticBatchingTest = __decorateClass([
    regClass170("0b1e65a6-6e00-4885-b58a-54ae9acbda08", "../src/3D/PerformanceTest/StaticBatchingTest.ts")
  ], StaticBatchingTest);
  ...
  PhysicsWorld_BaseCollider = __decorateClass([
    regClass171("3f74ca02-f4fc-4548-8292-63f8adf9ccde", "../src/3D/PhysicsWorld/PhysicsWorld_BaseCollider.ts")
  ...
  PhysicsWorld_BuildingBlocks = __decorateClass([
    regClass172("bff20f3d-f89d-431c-a225-c6962910008d", "../src/3D/PhysicsWorld/PhysicsWorld_BuildingBlocks.ts")
  ...
  PhysicsWorld_Character = __decorateClass([
    regClass173("20248bc4-a0e2-43b8-aa4c-b90c988dfbdf", "../src/3D/PhysicsWorld/PhysicsWorld_Character.ts")
  ...
  PhysicsWorld_CollisionFiflter = __decorateClass([
    regClass174("a45b1a31-9a36-4154-b987-246e1b1fb8b3", "../src/3D/PhysicsWorld/PhysicsWorld_CollisionFiflter.ts")
  ...
  PhysicsWorld_CompoundCollider = __decorateClass([
    regClass175("16ff281f-5149-414e-b707-2cfd0d770f48", "../src/3D/PhysicsWorld/PhysicsWorld_CompoundCollider.ts")
  ...
  PhysicsWorld_ConfigurableJoint = __decorateClass([
    regClass176("8a0ef41e-764f-4da2-976d-16a30f0f7618", "../src/3D/PhysicsWorld/PhysicsWorld_ConfigurableJoint.ts")
  ...
  PhysicsWorld_ConstraintFixedJoint = __decorateClass([
    regClass177("1e8563cf-8f4b-4799-a982-ac5f521833f1", "../src/3D/PhysicsWorld/PhysicsWorld_ConstraintFixedJoint.ts")
  ...
  PhysicsWorld_ContinueCollisionDetection = __decorateClass([
    regClass178("bb67b7fe-1ca5-4657-b7dc-fafd67ab7546", "../src/3D/PhysicsWorld/PhysicsWorld_ContinueCollisionDetection.ts")
  ...
  PhysicsWorld_Kinematic = __decorateClass([
    regClass179("92276d17-d5a1-4c38-8fe6-76e0770c3526", "../src/3D/PhysicsWorld/PhysicsWorld_Kinematic.ts")
  ...
  PhysicsWorld_MeshCollider = __decorateClass([
    regClass180("69c44b4c-3843-4260-8186-6b30c2038b01", "../src/3D/PhysicsWorld/PhysicsWorld_MeshCollider.ts")
  ...
  PhysicsWorld_RayShapeCast = __decorateClass([
    regClass181("28020748-173b-4117-922d-04dc28e79f78", "../src/3D/PhysicsWorld/PhysicsWorld_RayShapeCast.ts")
  ...
  __decorateClass([
    property182(Laya.Sprite3D)
  ], PhysicsWorld_TriggerAndCollisionEvent.prototype, "directionLight", 2);
  PhysicsWorld_TriggerAndCollisionEvent = __decorateClass([
    regClass182("4d873f7e-4cd7-4613-bca4-fd2851da4301", "../src/3D/PhysicsWorld/PhysicsWorld_TriggerAndCollisionEvent.ts")
  ...
  PixelLineSprite3DDemo = __decorateClass([
    regClass205("cc0f6877-b7f3-4e00-b4a7-a681765fca59", "../src/3D/Sprite3D/PixelLineSprite3DDemo.ts")
  ...
  ScreenShot = __decorateClass([
    regClass206("2d929ea3-aad3-4da4-afb3-6ccc73bd41f8", "../src/3D/Sprite3D/ScreenShot.ts")
  ], ScreenShot);
  ...
  SkinnedMeshSprite3DDemo = __decorateClass([
    regClass207("2696a176-66f9-4aac-81f7-dd3a6d9b0803", "../src/3D/Sprite3D/SkinnedMeshSprite3DDemo.ts")
  ...
  Sprite3DClone = __decorateClass([
    regClass208("6492c680-4d83-4ad7-8e22-558f7502a378", "../src/3D/Sprite3D/Sprite3DClone.ts")
  ], Sprite3DClone);
  ...
  Sprite3DParent = __decorateClass([
    regClass209("8a84c63f-4b5c-4951-a103-ddc9725dfb18", "../src/3D/Sprite3D/Sprite3DParent.ts")
  ], Sprite3DParent);
  ...
  TransformDemo = __decorateClass([
    regClass210("aaa3a9c3-1868-422a-bd97-2d89afac88e3", "../src/3D/Sprite3D/TransformDemo.ts")
  ], TransformDemo);
